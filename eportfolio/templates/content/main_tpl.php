...
$this->objTab->addTab(array('name'=> $this->objLanguage->code2Txt("word_name"),'content' => $namesLabel));
$this->objTab->tabId = FALSE;      
$this->objTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordAddress",'eportfolio'),'content' => $addressLabel));
$this->objTab->tabId = FALSE;      
$this->objTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordContact",'eportfolio'),'content' => $contactLabel));
$this->objTab->tabId = FALSE;      
$this->objTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordEmail",'eportfolio'),'content' => $emailLabel));
$this->objTab->tabId = FALSE;      
$this->objTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordDemographics",'eportfolio'),'content' => $demographicsLabel));
$addressTab = $this->objTab->show();

//Information tab
$page .= $featureBox->show($objinfoTitles->show(), $addressTab, 'box1', 'default', TRUE);


$this->objmainTab->init();
$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordInformation",'eportfolio'),'content' => $page));

//Activity Title
$objactivityTitles ->str =$objUser->getSurname ().$objLanguage->languageText("mod_eportfolio_activitylist", 'eportfolio');
$activitypage .= $featureBox->show($objactivityTitles->show(), $activityLabel,'box2', 'default', TRUE );
$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordActivity",'eportfolio'),'content' => $activitypage));

//Affiliation Title
$objaffiliationTitles ->str =$objUser->getSurname ().$objLanguage->languageText("mod_eportfolio_affiliationheading", 'eportfolio');

$affiliationpage .= $featureBox->show($objaffiliationTitles->show(), $affiliationTable->show(),'box3' , 'default', TRUE );
$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordAffiliation",'eportfolio'),'content' => $affiliationpage));

//Transcript Title
$objtranscriptTitles ->str =$objUser->getSurname ().$objLanguage->languageText("mod_eportfolio_transcriptlist", 'eportfolio');
$transcriptpage .= $featureBox->show($objtranscriptTitles->show(), $transcriptTable->show(),'box4', 'default', TRUE );
$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordTranscripts",'eportfolio'),'content' => $transcriptpage));

//Qcl Title
$objqclTitles ->str =$objUser->getSurname ().$objLanguage->languageText("mod_eportfolio_qclheading", 'eportfolio');
$qclpage .= $featureBox->show($objqclTitles->show(), $qclTable->show(),'box5', 'default', TRUE );
$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordQualification",'eportfolio'),'content' => $qclpage));

//Goals Title
$objgoalsTitles ->str =$objUser->getSurname ().$objLanguage->languageText("mod_eportfolio_goalList", 'eportfolio');
$goalspage .= $featureBox->show($objgoalsTitles->show(), $goalsTable->show(),'box6', 'default', TRUE );
$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordGoals",'eportfolio'),'content' => $goalspage));

//Competency Title
$objcompetencyTitles ->str =$objUser->getSurname ().$objLanguage->languageText("mod_eportfolio_competencylist", 'eportfolio');
$competencypage .= $featureBox->show($objcompetencyTitles->show(), $competencyTable->show(),'box7', 'default', TRUE );
$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordCompetency",'eportfolio'),'content' => $competencypage));

//interest Title
$objinterestTitles ->str =$objUser->getSurname ().$objLanguage->languageText("mod_eportfolio_interestList", 'eportfolio');
$interestpage .= $featureBox->show($objinterestTitles->show(), $interestTable->show(),'box8', 'default', TRUE );
$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordInterests",'eportfolio'),'content' => $interestpage));

//reflection Title
$objreflectionTitles ->str =$objUser->getSurname ().$objLanguage->languageText("mod_eportfolio_reflectionList", 'eportfolio');
$reflectionpage .= $featureBox->show($objreflectionTitles->show(), $reflectionTable->show(),'box9', 'default', TRUE );
$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordReflections",'eportfolio'),'content' => $reflectionpage));
...
$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordAssertion",'eportfolio'),'content' => $assertionspage));
...
$this->objTab->init();
$this->objTab->tabId = TRUE;      
$this->objTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_category","eportfolio"),'content' => $categoryLabel));
$this->objTab->tabId = TRUE;      
$this->objTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_categoryType","eportfolio"),'content' => $categorytypeLabel));
$categoryTab = $this->objTab->show();
//category tab

$categorypage .= $featureBox->show($objcategoryTitles->show(), $categoryTab, 'box11', 'default', TRUE );


$this->objmainTab->tabId = FALSE;      
$this->objmainTab->addTab(array('name'=> $this->objLanguage->code2Txt("mod_eportfolio_wordCategory",'eportfolio'),'content' => $categorypage));
}
...
$tabBox->addTab(array('name'=> $this->objLanguage->code2Txt("phrase_myePortfolio",'eportfolio'),'content' => $myeportfolioTab),'winclassic-tab-style-sheet');

$tabBox->addTab(array('name'=> $this->objLanguage->code2Txt("phrase_othersePortfolio",'eportfolio'),'content' => $epTable->show()),'winclassic-tab-style-sheet');
