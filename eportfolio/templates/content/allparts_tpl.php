<?php
	...
	$objHeading->type=3;
	$objHeading->align=center;
	$objHeading->str = '<font color="blue">'.$objUser->getSurname().' '.$objLanguage->languageText("mod_eportfolio_viewEportfolio",'eportfolio').'</font>';
	echo $objHeading->show();
	echo "</br>";
	$objHeading->type=2;
	$objHeading->str = '<font color="green">'.$objLanguage->languageText("mod_eportfolio_wordManage",'eportfolio').' '.$groupname.' '.$objLanguage->languageText("mod_eportfolio_wordGroup",'eportfolio').'</font>';
	echo $objHeading->show();
