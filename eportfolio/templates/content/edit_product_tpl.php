<?php
	...
	$textinput->size = 40;
	$row=array("<b>".$label = $objLanguage->languageText("mod_eportfolio_producttype",'eportfolio').":</b>");	
	$objTable->addRow($row, NULL);
	...
	$textinput->size = 40;
	$row=array("<b>".$label = $objLanguage->languageText("mod_eportfolio_wordComment",'eportfolio').":</b>");	
	$objTable->addRow($row, NULL);
	$row = array($textinput->show());	
	$objTable->addRow($row, NULL);
	...
	$textinput->size = 40;
	$row=array("<b>".$label = $objLanguage->languageText("mod_eportfolio_referentialSource",'eportfolio').":</b>");	
	$objTable->addRow($row, NULL);
	$row = array($textinput->show());	
	$objTable->addRow($row, NULL);
	...
	$textinput->size = 40;
	$row=array("<b>".$label = $objLanguage->languageText("mod_eportfolio_referentialId",'eportfolio').":</b>");	
	$objTable->addRow($row, NULL);
	$row = array($textinput->show());	
	$objTable->addRow($row, NULL);
	...
	$row=array("<b>".$label = $objLanguage->languageText("mod_eportfolio_assertionSource",'eportfolio').":</b>");	
	$objTable->addRow($row, NULL);
	...
	//assignment label
	$row=array("<b>".$label = $objLanguage->languageText("mod_eportfolio_assignmentSource",'eportfolio').":</b>");	
	$objTable->addRow($row, NULL);
	...
	$textinput->size = 40;
	$row=array("<b>".$label = $objLanguage->languageText("mod_eportfolio_essaySource",'eportfolio').":</b>");	
	$objTable->addRow($row, NULL);
	...
	$textinput->size = 40;
	$row = array("<b>".$label = $objLanguage->languageText("mod_eportfolio_shortProduct",'eportfolio').":</b>");
	$objTable->addRow($row, NULL);
	$row = array($textinput->show());	
	$objTable->addRow($row, NULL);
