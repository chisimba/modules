<?php
	...
	$objHeading->type=2;
	$objHeading->align=center;
	$objHeading->str = '<font color="blue">'.$objUser->fullName().' '.$objLanguage->languageText("mod_eportfolio_viewEportfolio",'eportfolio').'</font>';
	echo $objHeading->show();
...
$page .= $featureBox->show($objinfoTitles->show(), $addressTab,1 );
...
$activitypage .= $featureBox->show($objactivityTitles->show(), $activityLabel,$id = 2 );
$this->objmainTab->tabId = FALSE;      
...
$categorypage .= $featureBox->show($objcategoryTitles->show(), $categoryTab ,11 );
...
$tabBox->addTab(array('name'=> $this->objLanguage->code2Txt("phrase_othersePortfolio",'eportfolio'),'content' => NULL),'winclassic-tab-style-sheet');
