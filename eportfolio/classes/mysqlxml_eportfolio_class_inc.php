...
class mysqlxml_Eportfolio extends object
{
   ...
   public function convertToXML() {
	...
	$this->xmlIdentification->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imslip_v1p0','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imslip_v1p0 http://www.imsglobal.org/xsd/imslip_v1p0.xsd') );
	...
	//Type Name
        ...
        $tagIdent->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
	...
	$tagIdent->curtag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
	...
	$this->xmlQcl->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imslip_v1p0','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imslip_v1p0 http://www.imsglobal.org/xsd/imslip_v1p0.xsd') );
	...
	foreach ($qclList as $mainRow){
		...
		//Type Name
	        $mytype = $this->objDbCategorytypeList->listSingle($mainRow['qcl_type']);
   	        ...
   	        $xmlTag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
		...
		//Typename
   	        ...
   	        $xmlTag->curtag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
	...
	foreach( $aResultQcl as $a_tag2)
	{
		foreach( $a_tag2 as $a_tag1)
		{
			...
			{
			if(!empty($a_tag))
			    preg_match_all('/(href)=("[^"]*")/i',$a_tag, $aa[$a_tag]);
			}
		}
	}
	//Get Qcl Files
	...
	$this->xmlAffiliation->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imslip_v1p0','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imslip_v1p0 http://www.imsglobal.org/xsd/imslip_v1p0.xsd') );
	...
	foreach ($affiliationList as $mainRow){
		...
		//Type Name
	        $mytype = $this->objDbCategorytypeList->listSingle($mainRow['type']);
   	        ...
   	        $affTag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
		...
		//Typename
   	        ...
   	        $affTag->curtag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
		...
		//contentype
   	        ...
   	        $affTag->curtag->curtag->add_subtag("REFERENTIAL", array( 'sourcetype' => 'imsdefault' ) );
   	        $affTag->curtag->curtag->add_subtag("INDEXID", array());
...
//   	        $affTag->curtag->curtag->add_subtag("SHORT", array());
	...
	$this->xmlTranscript->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imslip_v1p0','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imslip_v1p0 http://www.imsglobal.org/xsd/imslip_v1p0.xsd') );
...
//	        $mytype = $this->objDbCategorytypeList->listSingle($mainRow['type']);
   	        ...
   	        $transTag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
	...
	$this->xmlActivity->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imslip_v1p0','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imslip_v1p0 http://www.imsglobal.org/xsd/imslip_v1p0.xsd') );
	...
	foreach ($activityList as $mainRow){
		...
		//Type Name
	        $mytype = $this->objDbCategorytypeList->listSingle($mainRow['type']);
   	        ...
   	        $actTag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
		...
		//Typename
   	        ...
   	        $actTag->curtag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
	...
	$this->xmlAssertion->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imslip_v1p0','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imslip_v1p0 http://www.imsglobal.org/xsd/imslip_v1p0.xsd') );
	...
	foreach ($assertionList as $mainRow){
		...
		//Typename
   	        ...
   	        $assertTag->curtag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
	...
	$this->xmlReflection->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imslip_v1p0','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imslip_v1p0 http://www.imsglobal.org/xsd/imslip_v1p0.xsd') );
	...
	foreach ($reflectionList as $mainRow){
		...
		//Typename
   	        ...
   	        $reflTag->curtag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
	...
	$this->xmlCompetency->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imslip_v1p0','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imslip_v1p0 http://www.imsglobal.org/xsd/imslip_v1p0.xsd') );
	...
	foreach ($competencyList as $mainRow){
		...
		//Type Name
	        $mytype = $this->objDbCategorytypeList->listSingle($mainRow['type']);
   	        ...
   	        $cotcyTag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
		...
		//Typename
   	        ...
   	        $cotcyTag->curtag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
	...
	$this->xmlInterest->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imslip_v1p0','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imslip_v1p0 http://www.imsglobal.org/xsd/imslip_v1p0.xsd') );
	...
	foreach ($interestList as $mainRow){
		...
		//Type Name
	        $mytype = $this->objDbCategorytypeList->listSingle($mainRow['type']);
   	        ...
   	        $intTag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
		...
		//Typename
   	        ...
   	        $intTag->curtag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
	...
	$this->xmlGoal->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imslip_v1p0','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imslip_v1p0 http://www.imsglobal.org/xsd/imslip_v1p0.xsd') );
	...
	foreach ($goalList as $mainRow){
		...
		//Type Name
	        $mytype = $this->objDbCategorytypeList->listSingle($mainRow['type']);
   	        ...
   	        $glTag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
		...
		//Typename
   	        ...
   	        $glTag->curtag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
		...
		//Typename
   	        ...
   	        $glTag->curtag->curtag->curtag->add_subtag("TYSOURCE", array( 'sourcetype' => 'imsdefault' ) );
	...
	$this->xmlImsManifest->roottag->set_attributes(array('xmlns' => 'http://www.imsglobal.org/xsd/imsportfoliocp_v1p0','xmlns:imsmd' => 'http://www.imsglobal.org/xsd/imsmd_v1p2','xmlns:xsi' => 'http://www.w3.org/2001/XMLSchema-instance','xsi:schemaLocation' => 'http://www.imsglobal.org/xsd/imsportfoliocp_v1p0 http://www.imsglobal.org/xsd/imsportfoliocp_v1p0.xsd http://www.imsglobal.org/xsd/imsmd_v1p2 http://www.imsglobal.org/xsd/imsmd_v1p2p2.xsd', 'identifier' => 'MANIFEST-9038769A-73K2-A91E-8RCF-4S484BGGE6C0','version' => '1.0' ) );
	...
	//Tag organizations
        $imsManiTag->add_subtag("organizations", array('default'=>$orgsDefaultId));
        $imsManiTag->curtag->add_subtag("organization", array('identifier'=>$orgsDefaultId));
        $imsManiTag->curtag->curtag->add_subtag("title", array());
	$imsManiTag->curtag->curtag->curtag->cdata = $userInfo['surname']."PortfolioPackage";
        $imsManiTag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPARTS-ROOT"));
        $imsManiTag->curtag->curtag->curtag->add_subtag("title", array());
	$imsManiTag->curtag->curtag->curtag->curtag->cdata = "PortfolioParts";
	//Identification
        $imsManiTag->curtag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPART-001",'identifierref' => "RES-PORTFOLIOPART-001"));
	...
	//Qualification
	if (!empty($qclList)) {
        $imsManiTag->curtag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPART-002",'identifierref' => "RES-PORTFOLIOPART-002"));
	$imsManiTag->curtag->curtag->curtag->curtag->add_subtag("title", array());
	$imsManiTag->curtag->curtag->curtag->curtag->curtag->cdata = "Qualification";
	}
	//Affiliation
	if (!empty($affiliationList)) {
        $imsManiTag->curtag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPART-003",'identifierref' => "RES-PORTFOLIOPART-003"));
	$imsManiTag->curtag->curtag->curtag->curtag->add_subtag("title", array());
	$imsManiTag->curtag->curtag->curtag->curtag->curtag->cdata = "Affiliation";
	}
	//Transcript
	if (!empty($transcriptList)) {
        $imsManiTag->curtag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPART-004",'identifierref' => "RES-PORTFOLIOPART-004"));
	$imsManiTag->curtag->curtag->curtag->curtag->add_subtag("title", array());
	$imsManiTag->curtag->curtag->curtag->curtag->curtag->cdata = "Transcript";
	}
	//Activity
	if (!empty($activityList)) {
        $imsManiTag->curtag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPART-005",'identifierref' => "RES-PORTFOLIOPART-005"));
	$imsManiTag->curtag->curtag->curtag->curtag->add_subtag("title", array());
	$imsManiTag->curtag->curtag->curtag->curtag->curtag->cdata = "Activity";
	}
	//Assertion
	if (!empty($assertionList)) {
        $imsManiTag->curtag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPART-006",'identifierref' => "RES-PORTFOLIOPART-006"));
	$imsManiTag->curtag->curtag->curtag->curtag->add_subtag("title", array());
	$imsManiTag->curtag->curtag->curtag->curtag->curtag->cdata = "Assertion";
	}
	//Reflexion
	if (!empty($reflectionList)) {
        $imsManiTag->curtag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPART-007",'identifierref' => "RES-PORTFOLIOPART-007"));
	$imsManiTag->curtag->curtag->curtag->curtag->add_subtag("title", array());
	$imsManiTag->curtag->curtag->curtag->curtag->curtag->cdata = "Reflexion";
	}
	//Competency
	if (!empty($competencyList)) {
        $imsManiTag->curtag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPART-008",'identifierref' => "RES-PORTFOLIOPART-008"));
	$imsManiTag->curtag->curtag->curtag->curtag->add_subtag("title", array());
	$imsManiTag->curtag->curtag->curtag->curtag->curtag->cdata = "Competency";
	}
	//Interest
	if (!empty($interestList)) {
        $imsManiTag->curtag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPART-009",'identifierref' => "RES-PORTFOLIOPART-009"));
	$imsManiTag->curtag->curtag->curtag->curtag->add_subtag("title", array());
	$imsManiTag->curtag->curtag->curtag->curtag->curtag->cdata = "Interest";
	}
	//Goal
	if (!empty($goalList)) {
        $imsManiTag->curtag->curtag->curtag->add_subtag("item", array('identifier' => "ITEM-PORTFOLIOPART-010",'identifierref' => "RES-PORTFOLIOPART-010"));
	$imsManiTag->curtag->curtag->curtag->curtag->add_subtag("title", array());
	...
	//Include Resources
        ...
        $imsManiTag->curtag->add_subtag("resource", array('identifier' => "RES-PORTFOLIOPART-001",'type' => "imslip-Identification"));
        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => "Identification.xml"));
	if (!empty($qclList)) {
        $imsManiTag->curtag->add_subtag("resource", array('identifier' => "RES-PORTFOLIOPART-002",'type' => "imslip-Qualification"));
        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => "Qualification.xml"));
	if(!empty($aPathQcl)){
	//Add image and files
		foreach($aPathQcl as $aPathQclN){
			...
			$myPath = "";
			//add file to the xml
		        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => $aFileNamePath));
	...
	if(!empty($imgPathQcl)){
		foreach($imgPathQcl as $imgPathQclN){
			...
			$myPath = "";
			//add file to the xml
		        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => $imgFileNamePath));
			//Add file to the zip file
	...
	if(!empty($affiliationList)){
        $imsManiTag->curtag->add_subtag("resource", array('identifier' => "RES-PORTFOLIOPART-003",'type' => "imslip-Affiliation"));
        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => "Affiliation.xml"));
	//Add image and files
	if(!empty($aPathAff)){
	...
	if (!empty($transcriptList)) {
        $imsManiTag->curtag->add_subtag("resource", array('identifier' => "RES-PORTFOLIOPART-004",'type' => "imslip-Transcript"));
        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => "Transcript.xml"));
	//Add image and files
	if (!empty($aPathTrans)) {
	...
	if(!empty($activityList)){
        $imsManiTag->curtag->add_subtag("resource", array('identifier' => "RES-PORTFOLIOPART-005",'type' => "imslip-Activity"));
        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => "Activity.xml"));
	//Add image and files
	...
	if(!empty($assertionList)){
        $imsManiTag->curtag->add_subtag("resource", array('identifier' => "RES-PORTFOLIOPART-006",'type' => "imslip-Assertion"));
        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => "Assertion.xml"));
	//Add image and files
	...
	if(!empty($reflectionList)){
        $imsManiTag->curtag->add_subtag("resource", array('identifier' => "RES-PORTFOLIOPART-007",'type' => "imslip-Reflexion"));
        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => "Reflexion.xml"));
	//Add image and files
	if(!empty($aPathRefl)){
	...
	if(!empty($competencyList)){
        $imsManiTag->curtag->add_subtag("resource", array('identifier' => "RES-PORTFOLIOPART-008",'type' => "imslip-Competency"));
        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => "Competency.xml"));
	//Add image and files
	...
	if(!empty($interestList)){
        $imsManiTag->curtag->add_subtag("resource", array('identifier' => "RES-PORTFOLIOPART-009",'type' => "imslip-Interest"));
        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => "Interest.xml"));
	//Add image and files
	if(!empty($aPathInt)){
	...
	if(!empty($goalList)){
        $imsManiTag->curtag->add_subtag("resource", array('identifier' => "RES-PORTFOLIOPART-010",'type' => "imslip-Goal"));
        $imsManiTag->curtag->curtag->add_subtag("file", array('href' => "Goal.xml"));
	//Add image and files
	if(!empty($aPathGoals)){
