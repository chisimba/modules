    ...
    */
    ...
    public function dispatch($action) 
    {
        ...
        switch ($action) {
            ...
            $this->setVarByRef('contacts', $contacts);
            ...
            $this->setVarByRef('qualification', $qualification);
            $this->setVarByRef('goals', $goals);
            $this->setVarByRef('competency', $competency);
        ...
        case 'makepdf':
            ...
            if (!empty($qualification)) $objPdf->partWrite($qualification);
            if (!empty($competency)) $objPdf->partWrite($competency);
            if (!empty($goals)) $objPdf->partWrite($goals);
