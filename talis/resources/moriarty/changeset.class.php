...
class ChangeSet extends SimpleGraph {
  ...
  function include_removal( $triple) {
    ...
    if ( $triple['o_type'] == 'iri' || $triple['o_type'] == 'bnode') {
      ...
      $this->add_literal_triple($removal, RDF_OBJECT, $triple['o'], $triple['o_lang'], $triple['o_dt'] );
    }
  ...
  function include_addition( $triple) {
    ...
    if ( $triple['o_type'] == 'iri' || $triple['o_type'] == 'bnode') {
      ...
      $this->add_literal_triple($addition, RDF_OBJECT, $triple['o'], $triple['o_lang'], $triple['o_dt'] );
    }
