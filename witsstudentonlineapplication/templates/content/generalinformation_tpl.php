...
//load our js
$generalinfojs = '<script language="JavaScript" src="'.$this->getResourceUri('js/generalinformation.js').'" type="text/javascript"></script>';
...
$this->appendArrayVar('headerParams', $generalinfojs);
