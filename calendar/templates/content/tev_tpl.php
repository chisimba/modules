...
$this->objMainheading->str=$objLanguage->languageText('mod_onlineinvoice_travelexpensevoucher');

/*create heading -- traveler information*/
$this->objheading =& $this->newObject('htmlheading','htmlelements');
$this->objheading->type = 3;
$this->objheading->str=$objLanguage->languageText('mod_onlineinvoice_travelerinformation');

/*create heading -- travel information*/
$this->objTravel =& $this->newObject('htmlheading','htmlelements');
$this->objTravel->type = 3;
$this->objTravel->str=$objLanguage->languageText('mod_onlineinvoice_travelinformation');
...
$description = $this->objLanguage->languageText('mod_onlineinvoice_pleaseprovideabriefdescriptionoftravelpurpose'); 
...
/*create table to place form elements in  --  date values*/
        ...
        $myTabIten->addCell($this->objtxtdeptdate->show());
        $myTabIten->endRow();
        ...
        $myTabIten->addCell($this->objtxtarrivdate->show());
        $myTabIten->endRow();
        ...
        $myTabIten->startRow();
        $myTabIten->addCell($this->objcity->show());
        ...
        //$myTabIten->addCell($this->objButtonNext->show());
        $myTabIten->endRow();*/
...
echo  '<br>'.$this->objIteninary->show();
echo  '<br>'."<div align=\"left\">" . $myTabIten->show() . "</div>";
