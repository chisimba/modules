...
$this->objMainheading->str=$objLanguage->languageText('mod_onlineinvoice_travelperdiemexpenses');
...
$this->objforeignheading->str=$objLanguage->languageText('mod_onlineinvoice_foreignrateperdiem')." " .$foreignRate;
...
$this->objdomesticheading->str=$objLanguage->languageText('mod_onlineinvoice_domesticrateperdiem') .' ' .$domesticRate;
...
$this->objdate->label($date,$lblDate);
/*----------------------------------------------------------------*/
...
$this->objnext->link($this->uri(array('action'=>'createinvoice')));
...
echo  '<br>'  . '<br>'.'<br>';
echo  "<div align=\"left\">"  . $myTabExpenses->show()  . "</div";
