...
public class SearchUserPanel {
    ...
    public SearchUserPanel(PermissionsFrame permissionsFrame) {
        ...
        RequestBuilder builder = new RequestBuilder(RequestBuilder.GET, GWT.getHostPageBaseURL() + "?module=dms&action=getallusers&searchfield=a");
            ...
            for (String folder : folders) {
                if (folder.length() > 0) {
                    ...
                    RequestBuilder builder =
                            ...
                            + "?module=dms&action=adduser&folderpath="
    ...
    private void refreshUsers(String name) {
        ...
        // use a http proxy to get the data
        RequestBuilder builder = new RequestBuilder(RequestBuilder.GET, GWT.getHostPageBaseURL() + "?module=dms&action=getallusers&searchfield=" + name);
        HttpProxy<String> proxy = new HttpProxy<String>(builder);
