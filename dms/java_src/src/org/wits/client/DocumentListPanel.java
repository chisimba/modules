...
public class DocumentListPanel extends LayoutContainer {
    ...
    public DocumentListPanel(Main main) {
        ...
        defaultParams = "?module=dms&action=getdocuments&mode=" + main.getMode();
    }
    ...
    protected void onRender(Element parent, int index) {
        ...
        RequestBuilder builder = new RequestBuilder(RequestBuilder.GET, GWT.getHostPageBaseURL() + "?module=dms&action=getdocuments");
    ...
    private void approveDocs() {
        ...
        String url =
                ...
                + Constants.MAIN_URL_PATTERN + "?module=dms&action=approvedocs&docids=" + ids;
    ...
    private void deleteDocs() {
        ...
        String url =
                GWT.getHostPageBaseURL()
                + Constants.MAIN_URL_PATTERN + "?module=dms&action=deletedocs&docids=" + ids;
        RequestBuilder builder =
                new RequestBuilder(RequestBuilder.GET, url);
    ...
    public void showEditDialog(final String docId) {
        ...
        RequestBuilder builder =
                ...
                + Constants.MAIN_URL_PATTERN + "?module=dms&action=getdocument&docid=" + docId);
