...
public class UserListPanel extends LayoutContainer {
    ...
    protected void onRender(Element parent, int index) {
        ...
        RequestBuilder builder = new RequestBuilder(RequestBuilder.GET, GWT.getHostPageBaseURL() + "?module=dms&action=getusers1");
    ...
    public void refreshUsers(String folder) {
        ...
        // use a http proxy to get the data
        RequestBuilder builder = new RequestBuilder(RequestBuilder.GET, GWT.getHostPageBaseURL() +Constants.MAIN_URL_PATTERN+ "?module=dms&action=getusers&foldername=" + folder);
        HttpProxy<String> proxy = new HttpProxy<String>(builder);
    ...
    private void removeUsers() {
        for (ModelData row : selectedRows) {
            RequestBuilder builder =
                    ...
                    + "?module=dms&action=removeuser&folderpath=" + permissionsFrame.getSelectedFolder() + "&userid=" + row.get("userid"));
