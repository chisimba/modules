...
public class ExtPanel {
    ...
    public ExtPanel() {
        ...
        RequestBuilder builder = new RequestBuilder(RequestBuilder.GET, GWT.getHostPageBaseURL() +Constants.MAIN_URL_PATTERN+ "?module=dms&action=getfileextensions");
    ...
    private void deleteExt() {
        for (ModelData row : selectedRows) {
            RequestBuilder builder =
                    ...
                    + "?module=dms&action=deleteext&id="
                    + row.get("id"));
    ...
    private void createNewExt(String extStr) {
        ...
        RequestBuilder builder =
                new RequestBuilder(RequestBuilder.POST, GWT.getHostPageBaseURL()
               +Constants.MAIN_URL_PATTERN+ "?module=dms&action=addfileextension&ext="
                + ext + "&desc=" + desc);
