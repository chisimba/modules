<?php
/**
* This class provides encryption for a webservice server using Blowfish for strings and arrays using session keys, which
* are regenerated daily. The primary purpose of the encryption is to encrypt
*
* IMPORTANT NOTE: THIS CLASS IS NOT DESIGNED TO BE CALLED WITHIN THE CHISIMBA FRAMEWORK BUT RATHER IS A STANDALONE
* CLASS MEANT TO RUN A SERVER WHICH IS PROVIDING WEBSERVICES WHICH NEEDS TO BE ENCRYPTED. DO NOT INVOKE THIS CLASS DIRECTLY FROM
* WITHIN THE CHISIMBA FRAMEWORK. THE CLASS NEEDS TO BE INCLUDED IN WEBSERVICES WHICH NEED TO MAKE USE OF ENCRYPTION.
*
* @package blowcrypt
* @category sems
...
class blowcryptserver
{
    ...
    */
    ...
    public function blowcryptserver()
    {
        $this->masterKeyPath = "\\crypt\\master.dat";
        $this->sessionKeyPath = "\\crypt\\session.dat";

		$this->encryptMethod = MCRYPT_BLOWFISH;
		$this->encryptMode = MCRYPT_MODE_ECB;
   ...
   private function generateSessionCheck($key)
    ...
    private function getCheckKeyFromFile()
    {
 	...
 	/**
	 * Method to get the encrypted current key
     *
	 * @return string - The session key
	 * @access public
     *
