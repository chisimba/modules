<?php 
   ...
   $this->loadClass('label','htmlelements'); 
    ...
    $row = array("<b>".$objLanguage->languageText("rubric_name")."</b>", $objUser->fullName());
    ...
    $labelObjective = new label($this->objLanguage->languageText("word_objectives"),"input_rows");
    ...
    $dropdown->addOption("8", "8");
    $dropdown->addOption("9", "9");
    $labelPerformance = new label($this->objLanguage->languageText("word_performance"),"input_cols");
    $row = array("<b>".$labelPerformance->show()."</b>", $dropdown->show());
    $objTable->addRow($row, 'even');
    $button = new button("submit", $objLanguage->languageText("word_next")); //word_create
    $button->setToSubmit();
    ...
    $createForm->addRule('title', $objLanguage->languageText('mod_rubric_pleaseentertitle', 'Please enter a title for the rubric.'),'required');
    $createForm->addRule('description', $objLanguage->languageText('mod_rubric_pleaseenterdescription','Please enter a description for the rubric.'),'required');
