...
$unit_of_area= new textinput('unit_of_area',$unitOfArea['0']['unit_of_area']);
...
$abbrev=new textinput('abbrev',$unitOfArea['0']['abbreviation']);
$formTable->startRow();
$formTable->addCell($label->show());
...
$remarksBox = new textarea('desc', $unitOfArea['0']['description'], 4, 40);
