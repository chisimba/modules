...
class blogops extends object
{
    ...
    public function showBlogsLink($featurebox = FALSE)
    {
        ...
        $ositeblogs = new href($this->uri(array('action' => 'siteblog')),$this->objLanguage->languageText("mod_blog_viewsiteblogs", "blog"), NULL);
    ...
    public function showAdminSection($featurebox = FALSE, $blogadmin = FALSE)
    {
        ...
        if($featurebox == FALSE)
        {
            ...
            //go to siteblog
            $siteblog = new href($this->uri(array('action' => 'siteblog')), $this->objLanguage->languageText("mod_blog_viewmyblog", "blog"));
