 ...
 * Code authoring tool
 * 
 * Code authoring tool for PHP, CSS, javascript, etc based on 
 * 
 * PHP version 5
 * 
...
/**
* 
* Controller class for Chisimba for the module codewriter
*
* @author Derek Keats
* @package codewriter
*
*/
class codewriter extends controller
{
    ...
    */
    ...
    /**
     * 
     * The standard dispatch method for the codewriter module.
