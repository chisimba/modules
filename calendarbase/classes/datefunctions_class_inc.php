...
class datefunctions extends object
{
    ...
    */
    function convertDateToTimestamp ($givenDate)
    {
    ...
    */
    function convertTimestampToDate ($timestamp, $format=NULL)
    {
        if (!isset($format)) {
            $format = 'Y-m-d';
        }
    ...
    * @return string formatted date
    */
    function lastDateMonth ($month, $year, $format=NULL)
    {
    ...
    */
    function previousDay($date, $format=NULL)
    {
    ...
    */
    function secondsInDay ($numDays = 1)
    {
    ...
    */
    ...
    function reformatDateSmallMonth ($date)
    {
        $timestamp = $this->convertDateToTimestamp($date);
    ...
    * @param string $date1 Second Date
    */
    function smallDateBigDate(&$date1, &$date2)
    {
