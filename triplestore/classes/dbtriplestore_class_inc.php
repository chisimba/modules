...
class dbtriplestore extends dbTable
{
    ...
    /**
     * Retrieves a triple according to its id.
     *
     * @access public
     * @param  string $id The autogenerated id of the triple to retrieve.
     * @return mixed  The associative array representing the retrieved triple or NULL if the triple could not be found.
     */
    public function getTripleById($id)
    {
