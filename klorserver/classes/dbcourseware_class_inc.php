...
*/
 ...
 class dbcourseware extends dbTable{
    /**
  ...
  /**
     ...
     */
     function insertFile($params){
        ...
        $title = $params['contextCode'];
        $name = $params['menutext'];       
	...
	function insertCourseFile($userId, $params,$filepath){
        $title = $params['title'];
        $name = $params['name'];       
