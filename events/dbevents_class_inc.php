...
class dbevents extends dbtable {
     ...
     */
    public function getEventInfo($eventid, $flag = NULL, $token = NULL) {
     ...
     */
    public function addEvent($token, $name, $venue_id, $category_id, $start_date, $end_date = NULL, $start_time, $end_time = NULL, $description = NULL, $url = NULL, $personal = 0, $selfpromotion = 0, $ticket_url = NULL, $ticket_price = NULL, $ticket_free = 0) {
     ...
     * @param $ticket_free (1 or 0, Optional, Defaults to 0) A flag indicating if the event is free (1) or not (0). 
     */
    public function editEvent($token, $event_id, $name, $venue_id, $category_id, $start_date, $end_date = NULL, $start_time, $end_time = NULL, $description = NULL, $url = NULL, $personal = 0, $selfpromotion = 0, $ticket_url = NULL, $ticket_price = NULL, $ticket_free = 0) {

    }

    /**
     * Add/Replace tags on an event (POST)
     *
     * Add/Replace the user's current tags on an event. 
     * This method expects to receive a string with all the tags the user wishes to have on the object. 
     ...
     * @param $tags (String, Required) A space-separated list of tags. Surround multi-word tags with quotes.
     * @see eventSearch()
     */
    public function eventAddTags($token, $event_id, $tags) {
     ...
     * @param $token (Required) An authentication token.
     * @param $event_id (Numeric, Required) The event_id of the event. To get a event_id, try the eventSearch function.
     * @param $tag (String, Required) A single "raw" tag to remove
     */
    public function eventRemoveTag($token, $event_id, $tag) {
     ...
     */
    public function eventSearch($search_text = NULL, $location = NULL, $radius = NULL, $place_id = NULL, $country_id = 28, $state_id = NULL, $metro_id = NULL, $venue_id = NULL, $woeid = NULL, $category_id = NULL, 
     ...
     *
     * Get a watchlist for an event. 
     * You must pass authentication parameters for this function. 
     ...
     */
    public function eventGetWatchlist($token, $event_id) {
     ...
     */
    public function venueAdd($token, $venuename, $venueaddress, $venuecity, $metro_id, $location, $venuezip, $venuephone, $venueurl, $venuedescription, $private = 0) {
