...
class dbusers extends dbTable
{
    ...
    **/
    ...
    /**
    * Method to return a list of users for a chat room
    *
    * @access public
    ...
    **/
    ...
    /**
    * Method to return a list of chat rooms for a user
    *
    * @access public
    ...
    *
    * @access public
    * @param string $userId  The id of the chat room user to be deleted
    * @return
    */
