...
// Set up the header.
    $header = $this->objLanguage->languageText('mod_commenttypeadmin_uploadicon','commenttypeadmin');
...
$objFile = new textinput ("upload");
$objFile->fldType = "file";
$objFile->size = 70;
//Create label for input
$filelabel = new label ($this->objLanguage->languageText("word_file"), "input_file");
