...
function setUpEditLinkForMovableOptions(formElementType,formElementFormLabel,btnUpdateDom){
...
//        jQuery(':input[name="formElementLayout"]').filter('[value="normal"]').attr('checked', true);
