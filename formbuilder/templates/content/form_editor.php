...
setUpEditPublishingParametersMenu();
    ...
    jQuery( "#dialog-box").dialog({ title: 'Form is Incomplete' });
            jQuery("#dialog-box").html('<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>This form does is incomplete and does not\n\
...
function highlightNewConstructedFormElement(elementToHighlight)
{
                            ...
                            setTimeout(function() {
            elementToHighlight.removeClass('ui-state-highlight', 1500);
        }, 2500);
}
