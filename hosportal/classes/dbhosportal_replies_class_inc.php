...
//        return $this->
    ...
    {
        // $data=array("userid"=>$userid,"title"=>$title,"commenttxt"=>$comments,"modified"=>$this->now(),"commenttxtshort"=>$comments,"unreplied"=>$unreplied,"replies" => $noofreplies );
//mysql_query("SELECT * FROM Persons ORDER BY age");"WHERE id='" . $id . "'"  LIKE '%" . $comments . "%'"
          //  "select*from tbl_hosportal_replies WHERE title LIKE $ order by modified desc limit 10 offset 0";
