	...
	*/
	private function editTerm($id)
    {
        ...
        */
        ...
        {
            case 'termupdated'     : $message = '<strong>'.$term.'</strong> '.$this->objLanguage->languageText('mod_glossary_hasBeenUpdated', 'glossary'); break;
            
            case 'seealsoadded'   : $message = $this->objLanguage->languageText('mod_glossary_seeAlsoHasBeenAdded', 'glossary').' <strong>'.$term.'</strong>'; break;
            
            case 'seealsodeleted' : $message = $this->objLanguage->languageText('mod_glossary_seeAlsoHasBeenDeleted', 'glossary').' <strong>'.$term.'</strong>'; break;
            
            case 'urladded'           : $message = $this->objLanguage->languageText('mod_glossary_urlHasBeenAdded', 'glossary').' <strong>'.$term.'</strong>'; break;
