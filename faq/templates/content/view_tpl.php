<?php
	...
	//Add the jquery stuff to th header
	$jqr = $this->getJavaScriptFile('1.4.2/jquery-1.4.2.min.js', 'jquery');

	//$jqr .= $this->getJavaScriptFile('jquery-script.js', 'faq');
	$jqr .= '<script type="text/javascript">
	...
	$this->appendArrayVar('headerParams', $jqr);
...
**/
    ...
    if (!empty($list)) {
        ...
        foreach ($list as $element) {
            echo "<li><a href=\"#".$element["id"]."\" id=\"".$element["id"]."\">";
            echo /*$index . " : " . */ nl2br($element["question"]);
            echo "</a></li>";
            
		//Link of answers as a div
		...
		<?php
				echo '<div class="wrapperDarkBkg" id="content'.$element["id"].'">';
				echo "<b>" . $index . ": " . "</b>" . $objLanguage->languageText("word_answer","system").": ";
		?>
