...
class userutils extends object {
    ...
    function getFiles($node) {
        ...
        foreach ($rows as $row) {
            ...
            $files[] = array(
                ...
                'filesize' => $size,
                'thumbnailpath' => '<img src="' . $this->sitePath . '/apo/resources/images/ext/' . $this->findexts($row['filename']) . '.png" width="22" height="22">',
            );
        }
        return $files;
    }
    ...
    function downloadFile($filepath,$filename) {
        ...
        $baseDir = $this->objSysConfig->getValue('FILES_DIR', 'apo');
