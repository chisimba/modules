...
//$leftSideColumn2 = $this->objLanguage->languageText("mod_freemind_jre").'.<br><br>';//.$this->objLanguage->languageText("mod_freemind_getfreemind");//$this->objLanguage->code2Txt('mod_freemind',array('context'=>'course'));
