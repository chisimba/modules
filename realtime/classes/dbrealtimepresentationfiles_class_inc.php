...
* of
*/
class dbrealtimepresentationfiles extends dbtable
{
    ...
    */
    ...
    public function convertFileFromFormat($id, $inputExt, $outputExt)
    {
        $source = $this->objConfig->getcontentBasePath().'realtime_presentations/'.$id.'/'.$id.'.'.$inputExt;
        $conv = $this->objConfig->getcontentBasePath().'realtime_presentations/'.$id.'/'.$id.'.'.$outputExt;
    ...
    public function deleteFile($id)
    {
        ...
        // Set Directory to Var
        $presentationFolder = $this->objConfig->getcontentBasePath().'realtime_presentation/'.$id;
    ...
    {
        $swfFile =  $this->objConfig->getcontentBasePath().'realtime_presentation/'.$id.'/'.$id.'.swf';
    ...
    {
        $objSlides = $this->getObject('realtimepresentationslides');
        $objSlides->deleteSlides($id);
    ...
    {
        $pdfFile =  $this->objConfig->getcontentBasePath().'realtime_presentation/'.$id.'/'.$id.'.pdf';
