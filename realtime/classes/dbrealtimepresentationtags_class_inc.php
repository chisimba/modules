 ...
 * @link      http://avoir.uwc.ac.za
 */
class dbrealtimepresentationtags extends dbtable
{
    ...
    */
    ...
    {
        parent::init('tbl_realtimepresentation_tags');
    }
    ...
    {
        $sql = 'SELECT tag, count( tag ) AS tagcount FROM tbl_realtimepresentation_tags GROUP BY tag ORDER BY tag';
    ...
    public function getFilesWithTag($tag, $order='dateuploaded DESC')
    {
        ...
        $sql = 'SELECT DISTINCT tbl_realtimepresentation_files.id, tbl_realtimepresentation_files.*, tbl_users.firstName as firstname, tbl_users.surname FROM tbl_realtimepresentation_files, tbl_realtimepresentation_tags, tbl_users
        WHERE (tbl_realtimepresentation_tags.fileid = tbl_realtimepresentation_files.id AND tbl_realtimepresentation_files.creatorid = tbl_users.userid) AND tbl_realtimepresentation_tags.tag LIKE \''.$tag.'\' ORDER BY '.$order;
