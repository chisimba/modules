...
public class RealtimeOptions {
    ...
    static String fileName = System.getProperty("user.home") +
            "/avoir-realtime-0.1/conf/realtime.properties";
    static String defaultFileName = System.getProperty("user.home") +
            "/avoir-realtime-0.1/conf/default.properties";
    static String confDir = System.getProperty("user.home") +
