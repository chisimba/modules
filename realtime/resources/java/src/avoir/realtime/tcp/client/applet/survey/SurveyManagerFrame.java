...
public class SurveyManagerFrame extends javax.swing.JFrame {
    ...
    public SurveyManagerFrame(TCPTunnellingApplet client) {
        this.client = client;
        initComponents();
    ...
    public void setSurveyAnswer(int row, boolean yes) {
       ...
       /* Integer yesCount = (Integer) model.getValueAt(row, 2);
        ...
        p.setMinimum(0);
        p.setMaximum(client.getUserCount() - 1);
    ...
    private void startButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        resetAnswers();
        client.getTCPClient().sendPacket(new SurveyPackPacket(client.getSessionId(),
    ...
    private void voteStartButtonActionPerformed(java.awt.event.ActionEvent evt) {
        client.getTCPClient().sendPacket(
                new VotePacket(client.getSessionId(), true, false, !allOpt.isSelected()));
    ...
    private void voteStopButtonActionPerformed(java.awt.event.ActionEvent evt) {
        client.getTCPClient().sendPacket(
                new VotePacket(client.getSessionId(), false, false, allOpt.isSelected()));
    ...
    private void voteResetButtonActionPerformed(java.awt.event.ActionEvent evt) {
        client.getTCPClient().sendPacket(new ClearVotePacket(client.getSessionId()));
        voteResetButton.setEnabled(false);
