...
public class OutlineTree extends JPanel {
    ...
    public OutlineTree(TCPTunnellingApplet applet) {
    ...
    private void init() {
       ...
       // warnLabel.setBackground(Color.WHITE);
        ...
        tree.setEditable(applet.isPresenter());
        ...
        rowSM.addTreeSelectionListener(new TreeSelectionListener() {
            ...
            public void valueChanged(TreeSelectionEvent e) {
                ...
                if (lsm.isSelectionEmpty()) {
                    ...
                    if (applet.isPresenter()) {
                        applet.updateSlide(rows[0] - 1);
                    }
                }
            }
        });
                ...
                if (e.getClickCount() == 1) {
                    ...
                    if (node == null) {
                        ...
                        if (applet.isPresenter()) {
                            ...
                            msgpopup.show(OutlineTree.this, e.getX(), e.getY());
                        }
                    }
                }
            }
    ...
    class MyTreeModelListener implements TreeModelListener {
        ...
        public void treeNodesChanged(TreeModelEvent e) {
            ...
            try {
                ...
                applet.renameOutlineItem((String) node.getUserObject(), index - 1);
