...
public class ClientList implements Serializable {
     ...
     */
    public synchronized void addElement(ObjectOutputStream stream, OutputStream audiostream, User user) {
     ...
     * @param stream the ObjectOutputStream
     */
    public synchronized void add(int index, ObjectOutputStream stream, OutputStream audiostream, User user) {
        removeUserIfExists(user);
     ...
     */
    public synchronized void removeElement(ObjectOutputStream stream, OutputStream audiostream) {
