...
public class ClientAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        snHostField.setText("196.21.45.85");
        snHostField.setPreferredSize(new java.awt.Dimension(150, 18));
        snHostField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                snHostFieldActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        snPortField.setText("80");
        snPortField.setPreferredSize(new java.awt.Dimension(163, 18));
        snPortField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                snPortFieldActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
    ...
    private void sendFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendFileButtonActionPerformed
        restartInfoLabel.setText("Sending ...");
...
private void snHostFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_snHostFieldActionPerformed
// TODO add your handling code here:
}//GEN-LAST:event_snHostFieldActionPerformed

private void snPortFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_snPortFieldActionPerformed
// TODO add your handling code here:
}//GEN-LAST:event_snPortFieldActionPerformed

    public void setLog(byte[] byteArray) {
        String home = avoir.realtime.tcp.common.Constants.getRealtimeHome() + "/log";
