...
public class HttpSocket extends Socket
{
	...
	/*
	 * The factory for all client HttpSockets.
	 */
	private static HttpSocketImplFactory factory=null;
	/*
	 * The implementation of this Socket.
	 */
	private HttpSocketImpl impl;
	 ...
	 *			   socket factory.
	 */
	public static synchronized void setSocketImplFactory(HttpSocketImplFactory fac)throws IOException
	{
		factory = fac;
	}
	...
	{
		impl = (factory != null) ? (HttpSocketImpl)factory.createSocketImpl() : new HttpSocketImpl();
	}
	 ...
	 */
	protected HttpSocket(HttpSocketImpl impl)
	{
		this.impl = impl;
	}
	 ...
	 * @exception  IOException  if an I/O error occurs when creating the socket.
	 */
	public HttpSocket(InetAddress address, int port) throws IOException
	{
	 ...
	 * @exception  IOException  if an I/O error occurs when creating the socket.
	 */
	public HttpSocket(String host, int port, InetAddress localAddr, int localPort) throws IOException
	{
		this();
		try
		{
	 ...
	 * @exception  IOException  if an I/O error occurs when creating the socket.
	 */
	public HttpSocket(InetAddress address, int port, InetAddress localAddr,int localPort) throws IOException
	{
		this();
		try
		{
...
/*		try
	...
	{
		return "HttpSocket[addr=" + impl.getInetAddress() +
			",port=" + impl.getPort() +
			",localaddr=" 
	...
	/**
	 * Some importmant optional parameters for HTTP proxy server
	 */
	/**
	 * Use USER or USERNAME to set username for the specific HTTP proxy serer.
	 */
	public static final String USER ="USER";
	public static final String USERNAME =USER;

	/**
	 * Use USERID,PASSWD or PASSWORD to set password for the specific HTTP proxy serer.
	 */
