...
public class ToolbarManager extends JToolBar {
    ...
    private void setCustomActions() {
        surveyButton.addActionListener(new  
        ...
        backSlideButton.addActionListener(new  
        ...
        firstSlideButton.addActionListener(new  
        ...
        lastSlideButton.addActionListener(new  
    ...
    private void initComponents() {
        ...
        handButton.addActionListener(new  
        ...
        chatButton.addMouseListener(new  
        ...
        voiceOptionsButton.addMouseListener(new  
    ...
    private void handButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        base.getTcpClient().sendAttentionPacket(base.getUser().getUserName(),
                base.getUser().getSessionId(), handButton.isSelected(),
                false, false, false, false, false,base.isSpeakerEnabled(),base.isMicEnabled());
    }
    ...
    private void yesButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        base.getTcpClient().sendAttentionPacket(base.getUser().getUserName(),
                base.getUser().getSessionId(), handButton.isSelected(),
                false, yesButton.isSelected(), noButton.isSelected(), true, base.getSessionManager().isPrivateVote(),base.isSpeakerEnabled(),base.isMicEnabled());
    ...
    private void noButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        base.getTcpClient().sendAttentionPacket(base.getUser().getUserName(),
                base.getSessionId(), handButton.isSelected(),
                false, yesButton.isSelected(), noButton.isSelected(), true, base.getSessionManager().isPrivateVote(),base.isSpeakerEnabled(),base.isMicEnabled());
