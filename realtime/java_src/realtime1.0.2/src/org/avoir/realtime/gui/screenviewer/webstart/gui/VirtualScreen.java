...
import org.avoir.realtime.gui.screenviewer.webstart.beans.VirtualScreenBean;
...
public class VirtualScreen {
	...
	public VirtualScreen() throws Exception{
		...
		Image im_left = ImageIO.read(StartScreen.class.getResource("/images/1leftarrow.png"));
		ImageIcon iIcon1 = new ImageIcon(im_left);
		Image im_right = ImageIO.read(StartScreen.class.getResource("/images/1rightarrow.png"));
		ImageIcon iIcon2 = new ImageIcon(im_right);
		Image im_up = ImageIO.read(StartScreen.class.getResource("/images/1uparrow.png"));
		ImageIcon iIcon3 = new ImageIcon(im_up);
		Image im_down = ImageIO.read(StartScreen.class.getResource("/images/1downarrow.png"));
