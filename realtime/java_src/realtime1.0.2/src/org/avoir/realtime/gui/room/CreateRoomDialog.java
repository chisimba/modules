...
public class CreateRoomDialog extends javax.swing.JDialog {
    ...
    private void createRoom() {
       ...
       Startup.realtimeFxInt.getChatRoomManager().createRoom(roomName, desc, maxNumber,
                requirePassword, password);
        if (Startup.realtimeFxInt.getRoomListFrame() != null) {
           Startup.realtimeFxInt.getRoomListFrame().requestRoomList();
        }
        dispose();
