package org.avoir.realtime.gui.screenviewer.jrdesktop;

import java.io.File;
import java.io.IOException;
import java.net.URL;

import org.avoir.realtime.gui.screenviewer.jrdesktop.server.rmi.Server;
import org.avoir.realtime.gui.screenviewer.jrdesktop.viewer.rmi.Viewer;
...
public class main {
    ...
    public static void startServer(int port) {
         ...
         org.avoir.realtime.gui.screenviewer.jrdesktop.server.Config.SetConfiguration(port);
        
        Server.Start();
    }    
    
    public static void startViewer(String server, int port) {        
     org.avoir.realtime.gui.screenviewer.jrdesktop.viewer.Config.SetConfiguration(server, port);
        new Viewer().Start();     
    }                
