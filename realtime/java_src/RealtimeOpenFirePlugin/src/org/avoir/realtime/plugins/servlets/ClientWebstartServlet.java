...
public class ClientWebstartServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<jnlp spec=\"1.0+\" codebase=\"" + audioVideoUrl + "/rchisimba\">");//  href=\"" + username + ".jnlp\">");
            ...
            out.println("<icon href=\"images/logo.png\"/>");
            out.println("<icon kind=\"splash\" href=\"images/splash_realtime.png\"/>");
            ...
            out.println("<jar href=\"l2fprod-common-all.jar\"/>");
            out.println("<jar href=\"PgsLookAndFeel.jar\"/>");
            ...
            out.println("</resources>");
            out.println("<application-desc main-class=\"org.avoir.realtime.gui.main.Main\">");
