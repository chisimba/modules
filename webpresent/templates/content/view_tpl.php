...
';
  ...
  *      * We need the agenda, so find it. If the presentation was not given any specific
   ...
   $objTabs->addTab($this->objLanguage->languageText("mod_webpresent_livepresentation", "webpresent"), $objView->createPresentationForm($file['id'],$agenda,$this->objUser->fullname()));
