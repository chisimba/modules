...
class feeder extends object 
{
	...
	function setupFeed($stylesheet = false, $title, $description, $link, $feedURL)
	{
	 ...
	 */
	function setrssImage($iTitle, $iURL, $iLink, $iDescription, $iTruncSize = 500, $desHTMLSyn = true)
	{
		$image = new FeedImage(); 
	 ...
	 */
	function addItem($itemTitle, $itemLink, $itemDescription, $itemSource, $itemAuthor)
	{
		$item = new FeedItem();
