...
class ADODB2_sapdb extends ADODB_DataDict {
	...
	function MetaType($t, $len = -1, $fieldobj = false) {
		...
		static $maxdb_type2adodb = array ('VARCHAR' => 'C', 'CHARACTER' => 'C', 'LONG' => 'X', // no way to differ between 'X' and 'B' :-(
'DATE' => 'D', 'TIMESTAMP' => 'T', 'BOOLEAN' => 'L', 'INTEGER' => 'I4', 'SMALLINT' => 'I2', 'FLOAT' => 'F', 'FIXED' => 'N' );
