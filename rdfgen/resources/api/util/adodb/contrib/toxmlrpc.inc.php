...
function rs2xmlrpcval(&$adodbrs) {
	...
	$xmlrpcrs = & new xmlrpcval ( array ("header" => $header, "body" => $body ), "struct" );
...
function rs2xmlrpcval_header($adodbrs) {
	...
	$header = & new xmlrpcval ( array ("fieldcount" => $fieldcount, "recordcount" => $recordcount, "sql" => $sql, "fieldinfo" => $fieldinfo ), "struct" );
