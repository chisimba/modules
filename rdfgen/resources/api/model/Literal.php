...
class Literal extends Node {
	...
	function equals($that) {
		...
		if (($this->label == $that->getLabel ()) && ((($this->lang == $that->getLanguage ()) || ($this->lang == NULL && $that->getLanguage () == NULL)) && 

		(($this->dtype == $that->getDatatype () || ($this->dtype == NULL && $that->getDatatype () == NULL))))) {
			return true;
		}
