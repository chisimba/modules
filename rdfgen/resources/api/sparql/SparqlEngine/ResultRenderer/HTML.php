...
class SparqlEngine_ResultRenderer_HTML implements SparqlEngine_ResultRenderer {
	...
	protected function wrapCode($strCode) {
		...
		return '<div class="SparqlEngine_ResultRenderer_HTML_result">' . "\n" . $strCode . "\n" . "</div>\n";
	} //protected function wrapCode($strCode)
	...
	protected function createValue($value) {
		...
		if ($value instanceof Literal) {
			$strCode = $this->getHtmlLiteral ( $value->getLabel (), $value->getLanguage (), $value->getDatatype () );
		...
		return '<td style="background-color: ' . RdfUtil::chooseColor ( $value ) . '">' . $strCode . '</td>';
