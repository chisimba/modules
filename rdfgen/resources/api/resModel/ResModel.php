 ...
 * @access	public
 **/
include 'ResLiteral.php';
include 'ResResource.php';
include 'ResProperty.php';
include 'ResIterator.php';
include 'ResBag.php';
class ResModel {
	...
	function findFirstMatchingStatement($subject, $predicate, $object, $offset = 0) {
		...
		if ($statement !== null) {
			return new Statement ( $this->_node2ResNode ( $statement->getSubject () ), $this->_node2ResNode ( $statement->getPredicate (), true ), $this->_node2ResNode ( $statement->getObject () ) );
		} else {
			return null;
		}
	}
