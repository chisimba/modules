...
class Gateway {
	...
	function service() {
		...
		{
			$ret = "<p>amfphp and this gateway are installed correctly. You may now connect " . 
				 "to this gateway from Flash.</p>";
				 
			if(function_exists("amf_decode"))
			{
				$ret .= "<p>AMF C Extension is loaded " .
					($GLOBALS['amfphp']['native'] ? "and enabled." : "but disabled") .
					"</p>";
			}
			$ret .= "<p>Note: If you're reading an " .
				 ...
				 "<a href='http://www.amfphp.org/docs'>View the amfphp documentation</a></p>" .
