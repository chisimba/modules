...
class dbtopic extends dbTable
 {
    ...
    */ 
    function showTopicsInForum($forum_id, $userId, $archiveDate = NULL, $order=NULL, $direction=NULL, $additionalWhere = NULL, $limit = NULL)
    {
        ...
        switch ($order)
        {
            case 'author': $sql .= ' firstName '.$direction; break;
            case 'lastpost': $sql .= ' lastdate '.$direction; break;
            case 'read': $sql .= ' readtopic '.$direction; break;
            case 'replies': $sql .= ' replies '.$direction; break;
            case 'status': $sql .= ' topicstatus '.$direction; break;
            case 'topic': $sql .= ' post_title '.$direction; break;
            case 'type': $sql .= ' type_name '.$direction; break;
            case 'views': $sql .= ' tbl_forum_topic.views '.$direction; break;
            default :  $sql .= ' tbl_forum_topic.dateLastUpdated DESC'; break;
        }
