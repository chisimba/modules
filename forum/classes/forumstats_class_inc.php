...
class forumstats extends dbTable
 {
    ...
    */
    ...
    {
        $sql = 'SELECT tbl_forum_post_ratings.userId, COUNT( tbl_forum_post_ratings.userId ) AS postsrated, SUM( rating_value ) AS totalvalue, MAX( rating_value ) AS maxvalue, MIN( rating_value ) AS minvalue
    ...
    */
    ...
    {
        $sql = 'SELECT tbl_forum_post.userId, COUNT( tbl_forum_post.userId ) AS postsrated, SUM( rating_value ) AS totalvalue, MAX( rating_value ) AS maxvalue, MIN( rating_value ) AS minvalue
        FROM tbl_forum_post_ratings
    ...
    */
    ...
    {
        $sql = 'SELECT tbl_forum_post.userId, COUNT( wordcount ) AS postscounted, SUM( wordcount ) AS totalwords, MAX( wordcount ) AS maxvalue, MIN( wordcount ) AS minvalue
