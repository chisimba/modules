...
$submitButton = new button('submit', $this->objLanguage->languageText('mod_forum_attachselected'));
...
$submitButton = new button('submit', $this->objLanguage->languageText('mod_forum_uploadfile'));
$submitButton->setToSubmit();
