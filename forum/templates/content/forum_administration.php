...
if ($this->getParam('message') != '') {
    ...
    if ($this->getParam('message') == 'defaultforumchanged') {
        $timeoutMessage = $this->getObject('timeoutmessage', 'htmlelements');
        $timeoutMessage->setMessage($this->objLanguage->languageText('mod_forum_defaultforumchanged'));
        $timeoutMessage->setTimeout(10000);
        echo ('<p>'.$timeoutMessage->show().'</p>');
    }
...
$table->addHeaderCell( $this->objLanguage->languageText('mod_forum_wordName'));
$table->addHeaderCell($this->objLanguage->languageText('mod_forum_visible'), NULL, NULL, 'center');
$table->addHeaderCell($this->objLanguage->languageText('mod_forum_forumlocked'), NULL, NULL, 'center');
$table->addHeaderCell($this->objLanguage->languageText('mod_forum_ratings'), NULL, NULL, 'center');
$table->addHeaderCell(ucwords($this->objLanguage->code2Txt('mod_forum_studentsstartTopics')), NULL, NULL, 'center');
$table->addHeaderCell($this->objLanguage->languageText('mod_forum_attachments'), NULL, NULL, 'center');
$table->addHeaderCell('Email', NULL, NULL, 'center');
$table->addHeaderCell($this->objLanguage->languageText('mod_forum_archivedate'), NULL, NULL, 'center');
$table->addHeaderCell('&nbsp;');
...
foreach ($forumsList as $forum)
{
    ...
    $forumLink->title = $this->objLanguage->languageText('mod_forum_goToForum');
    ...
    $editLink->link = $this->objLanguage->languageText('word_edit');
    $editLink->title = $this->objLanguage->languageText('mod_forum_editForumSettings');
    ...
    $editLink->alt = $this->objLanguage->languageText('word_edit');
    $editLink->title = $this->objLanguage->languageText('mod_forum_editForumSettings');
    ...
    if ($forum['defaultforum'] != 'Y') {
        ...
        $deleteLink->title = $this->objLanguage->languageText('mod_forum_deleteforum');
        $deleteLink->alt = $this->objLanguage->languageText('word_delete');
...
$forumLabel = new label('<nobr>* '.$this->objLanguage->languageText('mod_forum_defaultForum').' &nbsp;&nbsp;/&nbsp;&nbsp; '.$this->objLanguage->languageText('mod_forum_setDefaultForum').':</nobr>', 'input_forum');
...
$editLink->link = $this->objLanguage->languageText('mod_forum_createNewForum');

$backToForumListLink = new link($this->uri(NULL));
$backToForumListLink->link = $this->objLanguage->languageText('mod_forum_backtoforumindex');
