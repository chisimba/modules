 ...
 *
 * Bucket explorer Module for Amazon S3. Use it to manage files on Amazon S3 account, which uses the concept of buckets to store files.
 *
 * PHP version 5
 *
...
/**
*
* Controller class for Chisimba for the module buckets
*
* @author Derek Keats
* @package buckets
*
...
class buckets extends controller
{
    ...
    */
    ...
    /**
    *
    * Intialiser for the buckets controller
    * @access public
    *
    */
    public function init()
    {
        ...
        $this->key = $this->objConfig->getValue('mod_buckets_key', 'buckets');
        $this->secret = $this->objConfig->getValue('mod_buckets_secret', 'buckets');
    ...
    /**
     *
     * The standard dispatch method for the buckets module.
    ...
    */
    private function __view()
    {
        ...
        $oS = $this->getObject("s3", "utilities");
        $oS->setup($this->key, $this->secret);
        //$ar = $oS->getBuckets();
        //$str = $oS->createBucket('Chisimba Test Bucket');
        $str = $oS->directorySize('Chisimba Test Bucket');
        //$str = $oS->putObject('Chisimba Test Bucket', 'derektest', '/home/dkeats/instal-flash.txt', true);
        $this->setVarByRef('str', $str);
        //var_dump($oS->getBuckets());
