...
class filterdisplay extends object {
    ...
    function SideFilter($page, $SortFilter, $TotalPages, $adaptationstring, $browsemapstring, $NumFilter, $PageNum) {
        ...
        $form->addToForm('<div class="moduleSubHeader">');
        $form->addToForm($this->objLanguage->languageText('mod_unesco_oer_product_filter_criteria', 'unesco_oer') . '</div><br><div class="moduleHeader darkBlueText">');
        ...
        $form->addToForm($this->objLanguage->languageText('mod_unesco_oer_guide', 'unesco_oer') . '<br>');
        $form->addToForm($checkbox4->show());
        $form->addToForm($this->objLanguage->languageText('mod_unesco_oer_manual', 'unesco_oer') . '<br>');
