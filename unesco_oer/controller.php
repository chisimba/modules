...
//            $code = $name;
    ...
    public function __addUserInfo(){
        ...
        $country = $this->getParam('country');
        $this->objUseExtra->addUserInfo($title,$surname,$userid,$username,$password,$email,$firstname,$sex,$country,$birthdate, $address, $city, $state, $postaladdress, $organisation, $jobtittle, $WorkingPhone, $cellnumber, $DescriptionText, $WebsiteLink, $GroupMembership);
    }
    ...
    public function __editUserInfo(){
        ...
        //$id
        //userid
        $this->objUseExtra->editUserInfo($id,$staffnumber,$surname,$title,$userid,$username,$password,$email,$firstname,$sex,$country,$birthdate, $address, $city, $state, $postaladdress, $organisation, $jobtittle,$WorkingPhone, $cellnumber, $DescriptionText, $WebsiteLink, $GroupMembership);
    }
