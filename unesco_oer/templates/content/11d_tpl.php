...
<div class="breadCrumb module">
    <div id='breadcrumb'>
        <ul><li class="first"><?php echo $this->objLanguage->languageText('mod_unesco_oer_add_data_homeBtn', 'unesco_oer') ?></li>
           ...
           <li><?php echo $this->objDbGroups->getGroupName($this->getParam('id'))." "."INSTITUTIONS"?> </li>
...
<!--                <div class="topGroupDiv">
            ...
            <!-- Right column DIv -->
                                ...
                                <div class="rightColumnDiv">
                                    <div class="featuredHeader" ><?php  echo $this->objLanguage->languageText('mod_unesco_oer_featured_adaptation', 'unesco_oer') ?></div>
...
//                                               $coords=$this->$array_of_AdaptedProduct_COordinates;
                                            ...
                                            <?php } ?>
                                              ...
                                              <div id="map_canvas" style="width:178; height:110"></div>
<?php
