...
$form = new form ('register', $this->uri(array('action'=>'updateUserDetails'))); //register
//$form = new form ('register'); //register

$messages = array();
echo $this->getParam('username');
...
$button = new button ('submitform', 'Update User');
$button->setToSubmit();
//$updateLink = new link($this->uri(array('action' => "userListingForm",)));
//$updateLink->link =$button->show();



$form->addToForm('<p align="right">'.$button->show());
