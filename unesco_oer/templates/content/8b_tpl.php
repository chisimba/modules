        ...
        <div class="mainContentHolder">
          ...
          <div class="wideLeftFloatDiv">
            ...
            <div class="popupContent">
              <form method="" action="">
					<div class="label floaLeft">
                        <select name="" class="popUpDropDown">
...
<div class="label floaLeft">
                        ...
                        <div class="textNextoSubmitButton"><a href="" class="searchGoLink">SHOW</a></div>
                </div>
                </form>

                <div class="listAdaptations tenPixelTopPadding">
