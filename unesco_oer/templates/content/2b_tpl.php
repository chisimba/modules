        ...
        <div class="mainWrapper">
            ...
            <div class="mainContentHolder">
                ...
                <div class="leftColumnDiv">
                    ...
                    $form = new form('ThemeFilter', $this->uri(array('action' => 'FilterProducts', 'FilterProducts',  "adaptationstring" => $adaptationstring, "page" => '2b_tpl.php', "TotalPages"=> $TotalPages, "NumFilter"=> $NumFilter, "PageNum" => $i,'ThemeFilter' => $ThemeFilter, 'AuthorFilter' => $AuthFilter, 'LanguageFilter' => $LangFilter, 'SortFilter' => $SortFilter)));
...
<?php
                        ...
                        $form = new form('LanguageFilter', $this->uri(array('action' => 'FilterProducts',  "adaptationstring" => 'FilterProducts',  "adaptationstring" => $adaptationstring, "page" => '2b_tpl.php', "TotalPages"=> $TotalPages, "NumFilter"=> $NumFilter, "PageNum" => $i,'ThemeFilter' => $ThemeFilter, 'AuthorFilter' => $AuthFilter, 'LanguageFilter' => $LangFilter, 'SortFilter' => $SortFilter)));
...
<?php
                   ...
                   $filterAuth ->setSelected($AuthFilter);
                        $form = new form('AuthorFilter', $this->uri(array('action' => 'FilterProducts', 'FilterProducts',  "adaptationstring" => $adaptationstring, "page" => '2b_tpl.php', "TotalPages"=> $TotalPages, "NumFilter"=> $NumFilter, "PageNum" => $i,'ThemeFilter' => $ThemeFilter, 'AuthorFilter' => $AuthFilter, 'LanguageFilter' => $LangFilter, 'SortFilter' => $SortFilter)));
...
<!--                        <select name="author" id="author" class="leftColumnSelectDropdown">
                    ...
                    <div class="blueBackground">
                                            ...
                                            $form = new form('NumFilter', $this->uri(array('action' => 'FilterProducts',   "adaptationstring" => $adaptationstring, "page" => '2b_tpl.php', "TotalPages"=> $TotalPages, "NumFilter"=> $NumFilter, "PageNum" => $i,'ThemeFilter' => $ThemeFilter, 'AuthorFilter' => $AuthFilter, 'LanguageFilter' => $LangFilter, 'SortFilter' => $SortFilter)));
                    ...
                    <div class="GridListViewDiv">
                        <div class="sortBy">
                             ...
                             <?php
                                            ...
                                            $form = new form('SortFilter', $this->uri(array('action' => 'FilterProducts', 'FilterProducts',  "adaptationstring" => $adaptationstring, "page" => '2b_tpl.php', "TotalPages"=> $TotalPages, "NumFilter"=> $NumFilter, "PageNum" => $i,'ThemeFilter' => $ThemeFilter, 'AuthorFilter' => $AuthFilter, 'LanguageFilter' => $LangFilter, 'SortFilter' => $SortFilter)));
...
//                                                echo (int) $TotalPages;
                                                    ...
                                                    for ($i=1; $i<=$TotalPages; $i++)
                                                    {
                                                      ...
                                                      $abLink = new link($this->uri(array("action" => 'FilterProducts',  "adaptationstring" => $adaptationstring, "page" => '2b_tpl.php', "TotalPages"=> $TotalPages, "NumFilter"=> $NumFilter, "PageNum" => $i,'ThemeFilter' => $ThemeFilter, 'AuthorFilter' => $AuthFilter, 'LanguageFilter' => $LangFilter, 'SortFilter' => $SortFilter)));
                                                      $abLink->link = $i;
                                                      echo $abLink->show();
                                                     }
