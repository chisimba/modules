...
$newTopicForm = new form('newTopicForm', $this->uri(array('module' => 'forum', 'action' => 'savenewtopic', 'type' => 'context')));
...
$returnUrl = $this->uri(array('action' => 'forum', 'id' => $forumid, 'type' =>'context'));
