...
//define table
$tablename = 'tbl_unesco_oer_product_adaptation_data';
$options = array('comment'=>'Table to store adaptation specific data','collate'=>'utf8_general_ci','character_set'=>'utf8');
