...
class buildcanvas extends object
{
    ...
    /**
    *
    * Intialiser for the myprofile canvas builder
    *
    * @access public
    * @return VOID
    *
    */
    public function init()
    {
        ...
        $this->objPersonalSpaceBlocks = $this->getObject('dbmyprofile', 'myprofile');
    ...
    public function getEditOnButton()
    {
        if ($this->isOwner) {
...
// ]]>
    ...
    public function getContextBlocksJs()
    {
