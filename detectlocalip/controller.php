...
/**
* 
* Controller class for Chisimba for the module detectlocalip
*
* @author Derek Keats
* @package detectlocalip
*
*/
class detectlocalip extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the detectlocalip controller
    * @access public
    * 
    */
    ...
    /**
     * 
     * The standard dispatch method for the detectlocalip module.
    ...
    */
    private function __view()
    {
        ...
        $objIps = $this->getObject("dbipaddresses", "detectlocalip");
        $str .= $objIps->readData() . "<br /><br />Is local: " . $objIps->isLocal();
    ...
    */
    ...
    {
        $mode = $this->getParam("mode", NULL);
        $this->objDbdetectlocalip->save($mode);
        return $this->nextAction(NULL);
    }
