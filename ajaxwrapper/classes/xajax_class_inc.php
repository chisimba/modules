...
class xajax
{
    ...
    function registerFunction($mFunction,$sRequestType=XAJAX_POST)
    {
        ...
        if (is_array($mFunction)) {
            $this->aFunctions[$mFunction[1]] = 1;
            $this->aFunctionRequestTypes[$mFunction[1]] = $sRequestType;
            $this->aObjects[$mFunction[1]] = array_slice($mFunction, 0);
        }
        else {
...
//            require(dirname(__FILE__)."/xajaxCompress.php");
            ...
            $compressedScript = $this->xajaxCompressJavascript($javaScript);
