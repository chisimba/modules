...
class emailfiles extends dbTable
{
    ...
    public function init()
    {
        ...
        $this->filePath = $contentBasePath.'modules/email/';
        $this->tempPath = $contentBasePath.'modules/email/'.$this->userId.'/';
        $this->downloadLocation = $contentPath.'/modules/email/'.$this->userId.'/';
        // set upload size
