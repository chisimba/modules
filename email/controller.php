        ...
        switch($action){
            case 'managefolders':
                ...
                if($addbutton=='Submit'){
                    ...
                    return $this->nextAction('managefolders',array('currentFolderId'=>$currentFolderId));
            ...
            case 'compose':
                ...
                $xajaxCompose= new xajax($this->uri(array('action'=>'compose')));
                $xajaxCompose->registerFunction(array($this,"composeList"));
                $xajaxCompose->registerFunction(array($this,"addRecipient"));
                $xajaxCompose->registerFunction(array($this,"deleteRecipient"));
...
//                $this->setVarByRef('arrContextList',$arrContextList);
            ...
            case 'addressbook':
                ...
                $arrContextUserList=$this->objGroupAdmin->getSubGroupUsers($groupId,array('userId','firstName','surname','username'));
            ...
            case 'addentry':
                ...
                $this->loadClass('xajax','ajaxwrapper');
                //Register another function in this controller
                $xajaxUsername= new xajax($this->uri(array('action'=>'addentry','bookId'=>$bookId)));
                $xajaxUsername->registerFunction(array($this,"searchList"));
                //XAJAX method to be called
            ...
            case 'submitentry':
                ...
                return $this->nextAction('addressbook',array('bookId'=>$bookId));
                break;
            ...
            case 'upload':
                ...
                return $this->nextAction('compose',array('userId'=>$recipientList,'subject'=>$subject,'message'=>$message,'error'=>$error));
                break;
            ...
            case 'deleteattachment':
                ...
                unlink($file);
                return $this->nextAction('compose',array('userId'=>$recipientList,'subject'=>$subject,'message'=>$message));
                break;
            ...
            case 'deleterecipient':
                ...
                $this->loadClass('xajax','ajaxwrapper');
                //Register another function in this controller
                $xajaxUsername= new xajax($this->uri(array('action'=>'deleterecipient','recipientId'=>$recipientId)));
                $xajaxUsername->registerFunction(array($this,"deleteRecipient"));
                //XAJAX method to be called
                $xajaxUsername->processRequests();
                //Send JS to header
                $this->appendArrayVar('headerParams', $xajaxUsername->getJavascript());
            ...
            case 'messages':
                ...
                if($filter!=NULL){
                    return $this->nextAction('gotofolder',array('folderId'=>$folderId,'filter'=>$filter));
                }else{
                    return $this->nextAction('gotofolder',array('folderId'=>$folderId));
                }
                break;
            ...
            case 'managesettings':
                $this->loadClass('xajax','ajaxwrapper');
                //Register another function in this controller
                $xajaxSettings= new xajax($this->uri(array('action'=>'managesettings')));
                $xajaxSettings->registerFunction(array($this,"userDisplay"));
                $xajaxSettings->registerFunction(array($this,"buttonDisplay"));
                //XAJAX method to be called
            ...
            case 'updateconfig':
                ...
                return $this->nextAction('managesettings',array('section'=>$section));
                break;

            case 'managerules':
                $this->loadClass('xajax','ajaxwrapper');
                //Register another function in this controller
                $xajaxSettings= new xajax($this->uri(array('action'=>'managerules')));
                $xajaxSettings->registerFunction(array($this,"filterDisplay"));
                $xajaxSettings->registerFunction(array($this,"criteriaDisplay"));
                $xajaxSettings->registerFunction(array($this,"actionDisplay"));
                $xajaxSettings->registerFunction(array($this,"destDisplay"));
                //XAJAX method to be called
                $xajaxSettings->processRequests();
                //Send JS to header
                $this->appendArrayVar('headerParams', $xajaxSettings->getJavascript());
    ...
    */
    function searchList($search,$field)
    {
    ...
    * @return NULL
    */
    function addRecipient($userId,$recipientList)
    {
        $configs=$this->getSession('configs');
        $icon=$this->deleteIcon($userId);
        $this->loadClass('xajaxresponse','ajaxwrapper');
    ...
    * @return NULL
    */
    function deleteRecipient($userId,$recipientList)
    {
        $this->loadClass('xajaxresponse','ajaxwrapper');
    ...
    * @return NULL
    */
    function userDisplay($field,$value,$other)
    {
        $this->loadClass('xajaxresponse','ajaxwrapper');
    ...
    * @return NULL
    */
    function buttonDisplay($section)
    {
    ...
    * @return NULL
    */
    function filterDisplay($messageField)
    {
    ...
    * @return NULL
    */
    function criteriaDisplay($mailField)
    {
        $notApplicableLabel=$this->objLanguage->languageText('phrase_notapplicable');
    ...
    * @return NULL
    */
    function actionDisplay($mailAction)
    {
