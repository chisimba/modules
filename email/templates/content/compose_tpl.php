...
// set up code to text
    $array=array('filesize'=>$this->maxSize);
...
// set up address book icon
    ...
    $addressIcon=$objIcon->getLinkedIcon($this->uri(array('action'=>'manageaddressbooks')),'addressbook');
...
// set up attachments tabbed box
    ...
    $action=$this->uri(array('action'=>'upload'));
...
//    $objButton->setToSubmit();
    ...
    if(glob($files)!=FALSE){
        ...
        foreach(glob($files) as $filename){
            ...
            $deleteArray=$this->uri(array('action'=>'deleteattachment','file'=>$filename));
...
// set up form
    ...
    $objForm=new form('composeform',$this->uri(array('action'=>'sendemail')));
...
// set up hidden form
    ...
    $objForm=new form('hiddenform',$this->uri(array('action'=>'sendemail')));
    $objForm->addToForm($hiddenInput);
