...
class staffprofiles extends object {
    ...
    public function show() {
        ...
        $profiles = array(
            ...
            array("href"=>"19", "name"=>"Palesa Mokwena", "image"=>"palesamokwena.jpg", "jobtitle"=>"Intern (Web Developement)","ext"=>"7175", "email"=>"pmokwena@gmail.com"),
            array("href"=>"20", "name"=>"Dexters Mlambo", "image"=>"dextersmlambo.jpg", "jobtitle"=>"Intern (Web Developement)","ext"=>"7188", "email"=>"mirzadexter@gmail.com"),
            ...
            array("href"=>"10", "name"=>"Tessa Murray", "image"=>"tessa_murry.jpg", "jobtitle"=>"Team leader: Content developer","ext"=>"7178", "email"=>"tessa.murray@wits.ac.za"),
            ...
            array("href"=>"15", "name"=>"Nkaba Senne ", "image"=>"nkabasenne.jpg", "jobtitle"=>"Content Developer","ext"=>"7179", "email"=>"nkaba.senne@wits.ac.za"),
