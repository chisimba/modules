...
class staffprofiles extends object {
    ...
    public function show() {
        ...
        $profiles = array(
            ...
            array("href"=>"2", "name"=>"Rabelani Dagada", "image"=>"RDagada.jpg", "jobtitle"=>"eLearning Manager", "ext"=>"7184", "email"=>"rabelani.dagada@wits.ac.za"),
        ...
        $retstr = '<ul class="business_cards">';
                        ...
                        <li>
                            ...
                            <img width="75" height="90" class="left" alt="" src="'.$this->skinpath.'images/'.$row['image'].'">
