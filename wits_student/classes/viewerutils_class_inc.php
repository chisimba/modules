...
class viewerutils extends object {
    ...
    public function getHomePageContent() {
        ...
        $storyid=$this->objDbSysconfig->getValue('DEFAULT_STORY_ID','wits_student');
    ...
    public function getTopicsContent($parentid) {
        ...
        if($parentid == '') {
            $category=$this->objDbSysconfig->getValue('TOPIC_CATEGORY','wits_student');
    ...
    public function getArticlesContent($topic, $title) {
        ...
        $topiclink2=new link($this->uri(array("title"=>"wits_students past and present",'action'=>'viewtopic')));
        $topiclink2->link="wits_student's past and present";
