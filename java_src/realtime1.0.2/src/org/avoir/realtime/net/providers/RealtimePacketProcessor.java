    ...
    public static Item getItem(String xmlContents, String id) {
        ...
        try {
            ...
            if (type.equals("line")) {
                ...
                Rectangle rect = Startup.realtimeFxInt.getWhiteboard().getWhiteboardSize();
            ...
            if (type.equals("rect")) {
                ...
                Rectangle rectS = Startup.realtimeFxInt.getWhiteboard().getWhiteboardSize();
            ...
            if (type.equals("text")) {
                ...
                text.setGraphic(Startup.realtimeFxInt.getWhiteboard().getGraphics2D());
                text.setRed(red);
            ...
            if (GUIAccessManager.defaultPresentationName != null && GUIAccessManager.defaultSlideName != null) {
                ...
                try {
                    ...
                    if (slideImage == null) {
                        ...
                        Startup.realtimeFxInt.getWhiteboard().setSlideImage(slideImage);
                    }
                } catch (Exception ex) {
