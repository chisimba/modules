...
public class Whiteboard extends JPanel implements MouseListener, MouseMotionListener,
    ...
    public void setSlideImage(String url) {
        try {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand().equals("clear")) {
            Startup.realtimeFxInt.getWhiteboard().setSlideImage("/");
        }
        if (e.getActionCommand().equals("insertPresentation")) {
            Startup.realtimeFxInt.getSwingBinder().insertPresentation();
        }
    ...
    public void setCurrentPointer(int currentPointer) {
        ...
        textPopup.setVisible(false);
        textField.setText("");
        // whiteboardPanel.setWhiteboardToolbarEnabled(false);
        paintCurrentPointer();
    }
    ...
    public void paintPointer(int pointer, int x, int y) {
        ...
        if (pointer == PointerListPanel.ARROW_UP) {
            ...
            currentPointerX = 0;
            currentPointerY = 0;
        //   whiteboardPanel.setWhiteboardToolbarEnabled(true);
        }
        repaint();
    }
    ...
    public void mouseClicked(MouseEvent evt) {
        if (evt.getButton() == MouseEvent.BUTTON3) {
            if (GeneralUtil.isInstructor()) {
                ...
                //colorMenuItem.setEnabled(currentSelectedItem != null);
...
//whiteboardPanel.getMoveButton().setSelected(true);
    ...
    public boolean sendItem(Item item, String itemMode) {
        ...
        if (item instanceof Pen) {
            ...
            for (Line2D pt : pts) {
                double x1 = pt.getX1() / whiteboardSize.getWidth();
                double y1 = pt.getY1() / whiteboardSize.getHeight();
                double x2 = pt.getX2() / whiteboardSize.getWidth();
                double y2 = pt.getY2() / whiteboardSize.getHeight();
                sb.append(x1);
                sb.append(",");
                sb.append(y1);
                sb.append(",");
