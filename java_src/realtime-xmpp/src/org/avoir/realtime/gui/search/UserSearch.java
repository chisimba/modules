...
public class UserSearch extends javax.swing.JFrame {
    ...
    private String serviceName = "search." + connection.getServiceName();
    ...
    public void doSearch() {
        ...
        try {
            ...
            ReportedData data = search.getSearchResults(answerForm, serviceName);
            ...
            if (inviteParticipants != null) {
                ...
                rs.setLocationRelativeTo(GUIAccessManager.mf);
                rs.setVisible(true);
                dispose();
            } else {
