 ...
 * @author developer
 */
public class AnswerPacket implements RealtimePacket {
    ...
    public AnswerPacket(String question, ArrayList<Value> answerOptions, String id, String sender, String receiver) {
