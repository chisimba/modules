...
$ext .=$this->getJavaScriptFile('editassignment.js', 'turnitin');
$ext .=$this->getJavaScriptFile('editadvancedassigoptions.js', 'turnitin');
$ext .=$this->getJavaScriptFile('editadvancedassigoptions2.js', 'turnitin');
