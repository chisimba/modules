...
var title= "'.ucWords($this->objLanguage->code2Txt('mod_learningcontent_useractivitylogs','learningcontent'))." ".ucWords($this->objLanguage->code2Txt('mod_learningcontent_wordfor', 'learningcontent'))." ".$this->objContext->getTitle( $this->contextCode ).'";
var lang = new Array();
