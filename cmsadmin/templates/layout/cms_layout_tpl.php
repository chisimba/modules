...
$this->appendArrayVar('headerParams', $this->getJavascriptFile('yahoo/yahoo.js', 'cmsadmin'));
$this->appendArrayVar('headerParams', $this->getJavascriptFile('event/event.js', 'cmsadmin'));
$this->appendArrayVar('headerParams', $this->getJavascriptFile('dom/dom.js', 'cmsadmin'));
$this->appendArrayVar('headerParams', $this->getJavascriptFile('animation/animation.js', 'cmsadmin'));
$this->appendArrayVar('headerParams', $this->getJavascriptFile('connection/connection.js', 'cmsadmin'));
$this->appendArrayVar('headerParams', $this->getJavascriptFile('history/history-experimental.js', 'cmsadmin'));
$this->appendArrayVar('headerParams', $this->getJavascriptFile('container/container.js', 'cmsadmin'));
$this->appendArrayVar('headerParams', $this->getJavascriptFile('menu/menu.js', 'cmsadmin'));
$this->appendArrayVar('headerParams',$script);
$css = '<link rel="stylesheet" type="text/css" media="all" href="'.$this->getResourceURI("fonts/fonts.css", 'cmsadmin').'" />';
$css .= '<link rel="stylesheet" type="text/css" media="all" href="'.$this->getResourceURI("reset/reset.css", 'cmsadmin').'" />';
$css .= '<link rel="stylesheet" type="text/css" media="all" href="'.$this->getResourceURI("menu/assets/menu.css", 'cmsadmin').'" />';
