...
/************************************************************************************************************************************************/   
    ...
    */
        ...
        $myTabItenMulti  = $this->newObject('htmltable','htmlelements');
        $myTabItenMulti->width='60%';
        $myTabItenMulti->border='0';
        $myTabItenMulti->cellspacing = '1';
        $myTabItenMulti->cellpadding ='10';

        $myTabItenMulti->startRow();
        $myTabItenMulti->addCell($this->objdeparturedate->show());
        $myTabItenMulti->addCell($this->objdeptdate->show());
        $myTabItenMulti->endRow();

        $myTabItenMulti->startRow();
        $myTabItenMulti->addCell($this->objdeparturetime->show());
        $myTabItenMulti->addCell($this->objtxtdepttime->show());
        $myTabItenMulti->endRow();

        $myTabItenMulti->startRow();
        $myTabItenMulti->addCell($this->objdeparturecity->show());
        $myTabItenMulti->addCell($this->objtxtdeptcity->show());
        $myTabItenMulti->endRow();

        $myTabItenMulti->startRow();
        $myTabItenMulti->addCell($this->objarrivaldate->show());
        $myTabItenMulti->addCell($this->objarrivaldateobj->show());
        $myTabItenMulti->endRow();

        $myTabItenMulti->startRow();
        $myTabItenMulti->addCell($this->objarrivaltime->show());
        $myTabItenMulti->addCell($this->objtxtarrivtime->show());
        $myTabItenMulti->endRow();

        $myTabItenMulti->startRow();
        $myTabItenMulti->addCell($this->objarrivalcity->show());
        $myTabItenMulti->addCell($this->objtxtarrivcity->show());
        $myTabItenMulti->endRow();

        $myTabItenMulti->startRow();
        $myTabItenMulti->addCell($this->objButtonSave->show());
        $myTabItenMulti->addCell($this->objreturn->show());
        $myTabItenMulti->endRow();        
/************************************************************************************************************************************************/
        
$this->loadClass('tabbedbox', 'htmlelements');
$objmultiitinerary = new tabbedbox();
$objmultiitinerary->addTabLabel('Multiple Destination');
...
/************************************************************************************************************************************************/
     ...
     */         
      ...
      $objitenirarymultiForm = new form('lodging',$this->uri(array('action'=>'submititinerary')));
