...
//Create a new textinput for author
		$objauthor = new textinput('author');
		...
		$table->endRow();
                $objForm->addRule('author',$this->objLanguage->languageText("mod_author_required", 'libraryforms', 'Please enter an author. author is missing.'),'required');
