...
class contact_us extends object
{
    /**
    * Constructor
    */
    ...
    */
	...
	{
                $right_col = $this->newObject('contact_us_right_column', 'cfe');
	...
	{
		$content = '<div id="advPage"><h3> CONTACT US  </h3>

                <div id="advPageCont"> <h4> contact</h4> 
