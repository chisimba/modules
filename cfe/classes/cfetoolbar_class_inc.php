...
class cfetoolbar extends object {
    ...
    public function show() {
        ...
        // Add Home Link
        $tbar = $this->generateItem(NULL, '_default', 'Home', $usedDefault).
                $this->generateItem(NULL, '_default', 'Home2', $usedDefault).
                $this->generateItem(NULL, '_default', 'Home3', $usedDefault);;;
