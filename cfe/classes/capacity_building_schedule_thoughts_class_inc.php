...
class capacity_building_symposia_schedule extends object
{
    /**
    * Constructor
    */
    ...
    */
	...
	{
                $right_col = $this->newObject('capacity_building_right_column', 'cfe');
	...
	{
		$content = '<div id="advPage"><h3> CAPACITY BUILDING </h3>

                <div id="advPageCont"> <h4> capacity building</h4> 
