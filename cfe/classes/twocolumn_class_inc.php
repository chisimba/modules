...
class twocolumn extends object
{
    /**
    * Constructor
    */
   ...
   /**
	...
	private function buildBody()
	{
		...
		$this->pageContent->setMiddleColumnContent('<div id="aboutCFE"><div id="left"><div id="subhead"><div class="txt"><img src = "http://localhost/framework/app/packages/cfe/resources/subhead.gif"/></div></div><div class="bodytxt"><div id="cat_story"><h3>About CfE</h3>
...
<div id="right"><div id="rel_links"><div class="bl"><div class="br"><div class="tl"><div class="tr"><img src = "http://localhost/framework/app/packages/cfe/resources/subimg.jpg"/></a><br />
...
<tr><td><input type="text" id="q20461" name="p_email"  maxlength="500" class="input" value="Email address" /></td><td><input type="image" src = "http://localhost/framework/app/packages/cfe/resources/signup.jpeg" border="0"  class="img"></td></tr>
</table>
