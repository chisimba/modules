...
class donors_enterprise_development extends object
{
    /**
    * Constructor
    */
    ...
    */
	...
	{
                $right_col = $this->newObject('donors_and_sponsors_right_column', 'cfe');
	...
	{
		$content = '<div id="advPage"><h3> ENTERPRISE DEVELOPMENT  </h3>

                <div id="advPageCont"> <h4> ENTERPRISE DEVELOPMENT</h4> 
