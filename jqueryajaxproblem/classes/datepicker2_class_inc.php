 ...
 * @version   $Id: datepicker_class_inc.php 11973 2008-12-29 22:07:46Z charlvn $
 * @link      http://avoir.uwc.ac.za
 * @link      http://www.dynamicdrive.com/dynamicindex7/jasoncalendar.htm
 */
class datepicker2 extends object
{
    ...
    */
    function show()
    {
        $script = '<script type="text/javascript" src="'.$this->getResourceUri('calendarDateInput.js', 'jqueryajaxproblem').'">
...
***********************************************/
        ...
        return "<div id=\"datepicker_".$this->name."\"></div><script type=\"text/javascript\">
