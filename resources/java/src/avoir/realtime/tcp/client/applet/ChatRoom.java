...
public class ChatRoom
     ...
     * @param usr User
     */
    public ChatRoom(TCPClient client, String usr, String chatLogFile, String sessionId) {
    ...
    private void sendChat() {
        ChatPacket p = new ChatPacket(ChatRoom.this.usr, chatIn.getText() + "\n",
                getTime(), ChatRoom.this.chatLogFile, ChatRoom.this.sessionId);
        ChatRoom.this.tcpClient.addChat(p);
        chatIn.setText("");
    }
