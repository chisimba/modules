...
public class DynamicTree extends JPanel {
    ...
    public DynamicTree(RealtimeBase base) {
    ...
    public void init() {
        ...
        rootNode = new DefaultMutableTreeNode(new Slide(-1, "", "Outline", 0,false));
            ...
            public void valueChanged(TreeSelectionEvent e) {
                ...
                if (lsm.isSelectionEmpty()) {
                    ...
                    if (selectedNode.getPresentationName().equals("Whiteboard")) {
                        base.getWhiteboardSurface().setCurrentSlide(null, 0, 0, false);
                        base.getTcpClient().sendPacket(new ClearSlidesPacket(base.getSessionId()));
                    }
                    if (index > -1) {
