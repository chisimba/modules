...
public class RealtimeOptionsFrame extends javax.swing.JFrame {
    ...
    public RealtimeOptionsFrame(RealtimeBase applet, int selectedTabIndex) {
        ...
        directOpt.setSelected(applet.getRealtimeOptions().useDirectConnection());
        manualOpt.setSelected(applet.getRealtimeOptions().useManualProxy());
        systemOpt.setSelected(applet.getRealtimeOptions().useSystemProxy());
        cachingOpt.setSelected(applet.getRealtimeOptions().useCache());
        onlineSNOpt.setSelected(true);
        otherSNHostField.setText("127.0.0.1");
        otherSNPortField.setText("22225");
        proxyHostField.setText(applet.getRealtimeOptions().getProxyHost());
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {
        applet.getRealtimeOptions().setProxyHost(proxyHostField.getText());
        applet.getRealtimeOptions().setProxyPort(proxyPortField.getText());
        applet.getRealtimeOptions().setUseDirectConnection(directOpt.isSelected());
        applet.getRealtimeOptions().setUseManualProxy(manualOpt.isSelected());
        applet.getRealtimeOptions().setUseSystemProxy(systemOpt.isSelected());
...
//            applet.getTCPClient().setSuperNodeHost(otherSNHostField.getText());
  //          applet.getTCPClient().setSuperNodePort(Integer.parseInt(otherSNPortField.getText().trim()));
    ...
    private void saveChanges() {
        ...
        applet.getRealtimeOptions().setUseManualProxy(manualOpt.isSelected());
        applet.getRealtimeOptions().setUseSystemProxy(systemOpt.isSelected());
        applet.getRealtimeOptions().setUseCache(cachingOpt.isSelected());
//        client.refresh();
    ...
    private void clearCache() {
        String cache = avoir.realtime.tcp.common.Constants.getRealtimeHome() +"/presentations/";
    ...
    private void onlineSNOptActionPerformed(java.awt.event.ActionEvent evt) {
        applet.getRealtimeOptions().setUseOnlineSuperNodes(true);
    }

    private void localSNOptActionPerformed(java.awt.event.ActionEvent evt) {
        applet.getRealtimeOptions().setUseOnlineSuperNodes(false);
    }
