...
//                case 'outputtest':
//                    $temp = $this->getParam('test');
//                $this->setVar('test',$temp);
//                return "output.php";
//                break;
            case 'onlinesubmit':
            ...
            default:
                $msg = $this->getParam('confirm');
                $workgroupid=$this->getParam('workgroupid');
                $this->setVarByRef('workgroupid',$workgroupid);
                $mixed_arr = $this->Assignment->studentHome($msg,$workgroupid);
                //$this->setVarByRef('workgroupid',$workgroupid);
                $this->setVarByRef('essayData', $mixed_arr[0]);
                $this->setVarByRef('wsData', $mixed_arr[1]);
                $this->setVarByRef('testData', $mixed_arr[2]);
