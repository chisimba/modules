...
class functions_assignment extends object
{
    ...
    */
    public function studentHome($msg,$workgroupid)
    {
        ...
        $assignData = $this->dbAssignment->getAssignment($workgroupid,"context = '$this->contextCode'"); // pass $workgroupId here
