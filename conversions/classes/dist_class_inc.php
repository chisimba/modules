...
class dist extends object
{
    ...
    public function doConversion($value = NULL, $from = NULL, $to = NULL) 
    {
        ...
        //Does the convertion from Centimeters to Millimeters and returns the answer
        elseif ($from == "1" && $to == "2") {
        ...
        //Does the convertion from Centimeters to Feet and returns the answer
        elseif ($from == "1" && $to == "3") {
            $tempVal = $this->convCentimetersToMiles($value);
        ...
        //Does the convertion from Centimeters to Yards and returns the answer
        elseif ($from == "1" && $to == "4") {
            $tempVal = $this->convCentimetersToMiles($value);
        ...
        //Does the convertion from Centimeters to Meters and returns the answer
        elseif ($from == "1" && $to == "5") {
            $tempVal = $this->convCentimetersToMiles($value);
        ...
        //Does the convertion from Centimeters to Kilometers and returns the answer
        elseif ($from == "1" && $to == "6") {
            $tempVal = $this->convCentimetersToMiles($value);
        ...
        //Does the convertion from Centimeters to Miles and returns the answer
        elseif ($from == "1" && $to == "7") {
        ...
        //Does the convertion from Millimeters to Centimeters and returns the answer
        elseif ($from == "2" && $to == "1") {
        ...
        //Does the convertion from Millimeters to Feet and returns the answer
        elseif ($from == "2" && $to == "3") {
            $tempVal = $this->convMillimetersToMiles($value);
        ...
        //Does the convertion from Millimeters to Yards and returns the answer
        elseif ($from == "2" && $to == "4") {
            $tempVal = $this->convMillimetersToMiles($value);
        ...
        //Does the convertion from Millimeters to Meters and returns the answer
        elseif ($from == "2" && $to == "5") {
            $tempVal = $this->convMillimetersToMiles($value);
        ...
        //Does the convertion from Millimeters to Kilometers and returns the answer
        elseif ($from == "2" && $to == "6") {
            $tempVal = $this->convMillimetersToMiles($value);
        ...
        //Does the convertion from Millimeters to Miles and returns the answer
        elseif ($from == "2" && $to == "7") {
        ...
        //Does the convertion from Feet to Centimeters and returns the answer
        elseif ($from == "3" && $to == "1") {
        ...
        //Does the convertion from Feet to Millimeters and returns the answer
        elseif ($from == "3" && $to == "2") {
            $tempVal = $this->convFeetToMiles($value);
        ...
        //Does the convertion from Feet to Yards and returns the answer
        elseif ($from == "3" && $to == "4") {
            $tempVal = $this->convFeetToMiles($value);
        ...
        //Does the convertion from Feet to Meters and returns the answer
        elseif ($from == "3" && $to == "5") {
            $tempVal = $this->convFeetToMiles($value);
        ...
        //Does the convertion from Feet to Kilometers and returns the answer
        elseif ($from == "3" && $to == "6") {
            $tempVal = $this->convFeetToMiles($value);
        ...
        //Does the convertion from Feet to Miles and returns the answer
        elseif ($from == "3" && $to == "7") {
        ...
        //Does the convertion from Yards to Centimeters and returns the answer
        elseif ($from == "4" && $to == "1") {
        ...
        //Does the convertion from Yards to Millimeters and returns the answer
        elseif ($from == "4" && $to == "2") {
            $tempVal = $this->convYardsToMiles($value);
        ...
        //Does the convertion from Yards to Feet and returns the answer
        elseif ($from == "4" && $to == "3") {
            $tempVal = $this->convYardsToMiles($value);
        ...
        //Does the convertion from Yards to Meters and returns the answer
        elseif ($from == "4" && $to == "5") {
            $tempVal = $this->convYardsToMiles($value);
        ...
        //Does the convertion from Yards to Kilometers and returns the answer
        elseif ($from == "4" && $to == "6") {
            $tempVal = $this->convYardsToMiles($value);
        ...
        //Does the convertion from Yards to Miles and returns the answer
        elseif ($from == "4" && $to == "7") {
        ...
        //Does the convertion from Meters to Centimeters and returns the answer
        elseif ($from == "5" && $to == "1") {
        ...
        //Does the convertion from Meters to Millimeters and returns the answer
        elseif ($from == "5" && $to == "2") {
            $tempVal = $this->convMetersToMiles($value);
        ...
        //Does the convertion from Meters to Feet and returns the answer
        elseif ($from == "5" && $to == "3") {
            $tempVal = $this->convMetersToMiles($value);
        ...
        //Does the convertion from Meters to Yards and returns the answer
        elseif ($from == "5" && $to == "4") {
            $tempVal = $this->convMetersToMiles($value);
        ...
        //Does the convertion from Meters to Kilometers and returns the answer
        elseif ($from == "5" && $to == "6") {
            $tempVal = $this->convMetersToMiles($value);
        ...
        //Does the convertion from Meters to Miles and returns the answer
        elseif ($from == "5" && $to == "7") {
        ...
        //Does the convertion from Kilometers to Centimeters and returns the answer
        elseif ($from == "6" && $to == "1") {
        ...
        //Does the convertion from Kilometers to Millimeters and returns the answer
        elseif ($from == "6" && $to == "2") {
            $tempVal = $this->convKilometersToMiles($value);
        ...
        //Does the convertion from Kilometers to Feet and returns the answer
        elseif ($from == "6" && $to == "3") {
            $tempVal = $this->convKilometersToMiles($value);
        ...
        //Does the convertion from Kilometers to Yards and returns the answer
        elseif ($from == "6" && $to == "4") {
            $tempVal = $this->convKilometersToMiles($value);
        ...
        //Does the convertion from Kilometers to Meters and returns the answer
        elseif ($from == "6" && $to == "5") {
            $tempVal = $this->convKilometersToMiles($value);
        ...
        //Does the convertion from Kilometers to Miles and returns the answer
        elseif ($from == "6" && $to == "7") {
        ...
        //Does the convertion from Miles to Centimeters and returns the answer
        elseif ($from == "7" && $to == "1") {
        ...
        //Does the convertion from Miles to Millimeters and returns the answer
        elseif ($from == "7" && $to == "2") {
        ...
        //Does the convertion from Miles to Feet and returns the answer
        elseif ($from == "7" && $to == "3") {
        ...
        //Does the convertion from Miles to Yards and returns the answer
        elseif ($from == "7" && $to == "4") {
        ...
        //Does the convertion from Miles to Meters and returns the answer
        elseif ($from == "7" && $to == "5") {
        ...
        //Does the convertion from Miles to Kilometers and returns the answer
        elseif ($from == "7" && $to == "6") {
