...
/**
  ...
  */
  ...
  $this->objMainheading->str=$objLanguage->languageText('mod_marketingrecruitmentforum_facultescourses1','marketingrecruitmentforum');
...
/**faculty and course list**/
  ...
  //VAR_DUMP($coursevals);
  for($i=0; $i < count($course); $i++){//---CHANGED course with webserver call passed to template
...
$objForm = new form('studendtfaccrse',$this->uri(array('action'=>'studentfinal')));
$objForm->displayType = 3;
$objForm->addToForm($content . '<br/>'.$myTable->show());


$objForm1 = new form('faccrsebutton',$this->uri(array('action'=>'lastinfo')));
