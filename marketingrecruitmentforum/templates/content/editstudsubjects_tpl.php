...
/**
  ...
  */
  ...
  $this->objMainheading->str=$objLanguage->languageText('mod_marketingrecruitmentforum_editsubjects','marketingrecruitmentforum');
...
/**
  ...
  */
$phrase = '<b>'.'Please select your school subjects and grade'.'<b/>';  
$objForm = new form('studedudata',$this->uri(array('action'=>'showeditsubjectoutput')));
$objForm->displayType = 3;
$objForm->addToForm($content . '<br/>'.$phrase.$myTable->show());
...
$objForm->addRule('txtPercentage2','Must be numeric','numeric');
...
$objForm->addRule('txtPercentage3','Must be numeric','numeric');
...
$objForm->addRule('txtPercentage4','Must be numeric','numeric');
...
$objForm->addRule('txtPercentage5','Must be numeric','numeric');
...
$objForm->addRule('txtPercentage6','Must be numeric','numeric');
