...
/*------------------------------------------------------------------------------*/
  ...
  {
    $stmt = "LOAD DATA INFILE '/srv/www/htdocs/5ive/app/usrfiles/faculty_values.txt' INTO TABLE tbl_academicprogramme_faculties FIELDS TERMINATED BY ','";
...
/*------------------------------------------------------------------------------*/
  ...
  {
    $stmt = "LOAD DATA INFILE '/srv/www/htdocs/5ive/app/usrfiles/course_values.txt' INTO TABLE tbl_academicprogramme_courses FIELDS TERMINATED BY ','";
