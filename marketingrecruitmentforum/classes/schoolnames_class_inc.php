 ...
 */
	...
	public function init()
	{
	 try {
      ...
      $this->objPath = &$this->newObject('altconfig', 'config');
 ...
 */
    ...
    $file_to_read = fopen($this->objPath->getModulePath().$this->getResourceURI("schoolnames.csv"), "r") or die ("file does not exist or could not open file");
 ...
 */
  public function readareadata(){
                    //@fopen("modules/marketingrecruitmentforum/resources/postcodes.csv", "r") or die ("file does not exist or could not open file");
    $file_to_read = @fopen($this->objPath->getModulePath().$this->getResourceURI("postcodes.csv"), "r") or die ("file does not exist or could not open file");
