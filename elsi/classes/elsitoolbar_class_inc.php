...
class elsitoolbar extends object {
    ...
    public function show() {
        ...
        $menuOptions = array(
            array('action' => 'login', 'text' => 'About', 'actioncheck' => array(), 'module' => 'elsi', 'status' => 'login'),
            array('action' => 'login', 'text' => 'Staff', 'actioncheck' => array(), 'module' => 'elsi', 'status' => 'login'),
            array('action' => 'login', 'text' => 'Software', 'actioncheck' => array(), 'module' => 'elsi', 'status' => 'login'),
            array('action' => 'login', 'text' => 'Research', 'actioncheck' => array(), 'module' => 'elsi', 'status' => 'login'),
            array('action' => 'login', 'text' => 'About', 'actioncheck' => array(), 'module' => 'elsi', 'status' => 'login'),
