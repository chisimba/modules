 ...
 * @version   $Id: controller.php 12918 2009-03-18 10:32:59Z nic $
...
class ahis extends controller {
	...
	public function init() {
        try {
            ...
            $this->adminActions = array('admin', 
										'employee_admin', 
										'geography_level3_admin',
                                        'age_group_admin', 
										'title_admin', 
										'sex_admin', 
										'status_admin',
                                        'geography_level2_admin', 
										'prodution_admin', 
										'territory_admin',
                                        'report_admin', 
										'quality_admin', 
                                        ...
                                        'control_admin', 
										'outbreak_admin', 
										'geography_level3_delete',
                                        'geography_level3_add', 
										'geography_level3_insert', 
										'create_territory',
                                        'territory_insert', 
										'employee_admin', 
										'employee_insert', 
										...
										'survey_delete',
										'farmingsystem_add',
										'farmingsystem_insert',
                                        'farmingsystem_delete',
										'vaccinationhistory_add',
										'vaccinationhistory_insert',
