 ...
 * @version   $Id: tabsmenu_class_inc.php 12918 2009-03-18 10:32:59Z nic $
...
class tabsmenu extends object
{
    ...
    */
    function init()
    {
		...
		$this->menuItems['movement'] = array('text'=>$this->objLanguage->languageText('mod_ahis_animalmovement', 'ahis'), 'link'=>$this->uri(array('action'=>'animalmovement'), 'ahis'), 'class'=>'homelink');
		
		$this->menuItems['import'] = array('text'=>$this->objLanguage->languageText('mod_ahis_livestockimport', 'ahis'), 'link'=>$this->uri(array('action'=>'livestockimport'), 'ahis'), 'class'=>'homelink');
