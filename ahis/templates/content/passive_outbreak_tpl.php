...
$latitudeBox = new textinput('latitude', $latitude, 'text', 30);
$longitudeBox = new textinput('longitude', $longitude, 'text', 30);
...
$objTable->addCell($latitudeBox->show(),NULL,'center');
$objTable->endRow();
$objTable->startRow();
$objTable->addCell($this->objLanguage->languageText('word_longitude').":$tab");
$objTable->addCell($longitudeBox->show(),NULL,'center');
$objTable->endRow();
$objTable->startRow();
