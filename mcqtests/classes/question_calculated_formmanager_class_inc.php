...
class question_calculated_formmanager extends object {
    ...
    public function newGeneralForm($data=null) {
    ...
    public function calcQForm($testid) {
        ...
        $objFormEdit->addToForm("<br />" . $btnSave . " " . $btnCancel . "<br />");
    ...
    public function matchingQForm($testid, $data=null, $edit=null) {
        $this->id = $testid;
        $objGeneralFieldset = $this->newGeneralForm($data);
        $matchingNote = $this->getMatchingNote();
        $objAnswerFieldset = $this->matchingAForms($edit);
        ...
        return $objForm->show();/*echo "hello World";*/
    }

    public function matchingAForms($edit) {
        $retStr = "";
        ...
        if($edit) {
            ...
            echo "ID is: $this->id";
            $answers = $objMatchingQuestions->getMatchingQuestions($this->id);
            print_r($answers);
        }
        else {
            $answer = "";
