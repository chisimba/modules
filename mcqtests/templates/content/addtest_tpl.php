...
$objTable->addRow(array($objLabel->show(), $objDropDown->show()));
...
$objTable->addRow(array($objLabel->show(), $statusShow));
...
$objTable->addRow(array($objLabel->show(), $dropStr));
...
$objTable->addRow(array($objLabel->show(), $input));
...
$objTable->addRow(array("<b>".$testTypeLabel.":</b>","<b>".$testTypeRadio."</b>"));
...
$objTable->addRow(array("<b>".$qSequenceLabel.":</b>","<b>".$qSequenceRadio."</b>"));
...
$objTable->addRow(array("<b>".$aSequenceLabel.":</b>","<b>".$aSequenceRadio."</b>"));
...
$objLink=new link($this->uri(array('action'=>'addlab','id'=>$id,'mode'=>$mode)));
$objLink->link=$addLabLabel;
$labLink=$objLink->show();

$objTable->addRow(array("<b>".$restrictLabel.":</b>",$labDrop."&nbsp;&nbsp;".$labLink));
...
$objForm = new form('savetest',$this->uri(array('action'=>'applyaddtest')));
...
$objForm = new form('exit', $this->uri(array('action'=>'applyaddtest')));
