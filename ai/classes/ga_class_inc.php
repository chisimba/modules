...
class ga extends object
{
	...
	public function mutate(&$object,$mutation_function) 
	{
		...
		foreach ($properties as $property => $value) 
		{
				$object->$property = $object->$mutation_function($object->$property);
		}
	}
	...
	public function select($objects, $fitness_function, $n=2) 
	{
		...
		{
			//var_dump($object,$object->$fitness_function($object));
			$selection[] = array($object,$object->$fitness_function($object));
		}
