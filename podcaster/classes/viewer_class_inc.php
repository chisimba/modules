 ...
 */
    public function getLatestFeed()
    {
        ...
        $description =$this->objLanguage->languageText("mod_podcaster_listphrase", "podcaster").' '.$this->objConfig->getSiteName().' '.$this->objLanguage->languageText("mod_podcaster_site", "podcaster");
