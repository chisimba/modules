...
class conferencetoolbar extends object
{
    ...
    */
    public function show()
    {
        ...
        $menuOptions = array(
            array('action'=>'', 'text'=>'Register', 'actioncheck'=>array(), 'module'=>'witsconferences', 'status'=>'login'),
            array('action'=>'', 'text'=>'Organizers', 'actioncheck'=>array(''), 'module'=>'witsconferences', 'status'=>'both'),
            array('action'=>'null', 'text'=>'Program', 'actioncheck'=>array(), ''=>'witsconferences', 'status'=>'both'),
            array('action'=>'', 'text'=>'Sponsors', 'actioncheck'=>array(''), 'module'=>'witsconferences', 'status'=>'both'),
