...
$iconAdd->setIcon('add');
$iconAdd->alt = $objLanguage->languageText("mod_faq_addcategory", "faq");
$iconAdd->align=false;
$objLink->link = $iconAdd->show();
 		
// Add the Icon to the heading
$objHeading->str =$objLanguage->languageText("mod_faq_heading","faq").' '.$objLink->show();
//$objHeading->str =$objLanguage->languageText("mod_faq_heading")." : ".$contextTitle;
...
$objTable->addHeaderCell($objLanguage->languageText("mod_faq_category","faq"), 200);
$objTable->addHeaderCell($objLanguage->languageText("mod_faq_noitems","faq"), 200);
$objTable->addHeaderCell($objLanguage->languageText("mod_faq_action","faq"), 100);
...
foreach ($categories as $item) {
    ...
    $objAddLink->link($this->uri(array('action'=>'addCategory','category'=>$item['id']), 'faq'));
...
$addLink = new link($this->uri(array('action'=>'addCategory')));
$addLink->link = $objLanguage->languageText('mod_faq_addcategory','faq');

//$returnToFaqLink = new link($this->uri(NULL, 'faq'));
//$returnToFaqLink->link = $objLanguage->languageText('mod_faq_returntofaq');
