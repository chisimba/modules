...
class faq2Tools extends object
{
    /**
    ...
    */
    ...
    {
        $this->objTopic = $this->getObject('dbfaqcategories', 'faq2');
    ...
    */
    ...
    {
       // $topicBlock = $this->objTopic->showCategoryList();
    ...
    */
    private function showLoginBlock()
    {
	    ...
	    $block = $objLogin->renderLoginBox('faq2');
    ...
    */
    private function showManageList()
    {
        ...
        $lbManage = $this->objLanguage->languageText('mod_faq2_category','faq2');
        $lbAddCat = $this->objLanguage->languageText('mod_faq2_addcategory','faq2');
        $lbmanCat= $this->objLanguage->languageText('faq2_managecategories','faq2');
        
        $objLink = new link($this->uri(array('action' => 'addcategory')));
        $objLink->link = $lbAddCat;
        $str = $objLink->show();

        $objLink = new link($this->uri(array('action' => 'managecats')));
        $objLink->link = $lbmanCat;
        $str .= '<br />'.$objLink->show();
