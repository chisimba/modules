...
/**
 * 
 * A throwaway module to demonstrate templating
 * 
 * A throwaway module to demonstrate templating in Chisimba. This will replace some of the hard rendering that currently exists.
 * 
 * PHP version 5
 * 
 ...
 * @category  Chisimba
 * @package   helloforms
 * @author    A bunch of us derek@dkeats.com
...
/**
* 
* Controller class for Chisimba for the module demotemplate
*
* @author A bunch of us
* @package demotemplate
*
*/
class demotemplate extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the demotemplate controller
    * @access public
    * 
    */
    public function init()
    {
        ...
        $this->objDbdemotemplate = & $this->getObject('dbdemotemplate', 'demotemplate');
    ...
    /**
     * 
     * The standard dispatch method for the demotemplate module.
    ...
    public function dispatch()
    {
        ...
        */
        ...
        //Set a page template in this module
    ...
    */
    ...
    {
        $mode = $this->getParam("mode", NULL);
        $this->objDbdemotemplate->save($mode);
