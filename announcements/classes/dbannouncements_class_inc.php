...
//  $this->objIndexData->optimize();
                ...
                if ($email) {
                    ...
                    $title = "Important site announcement: '$title'";
                    $message = $this->objUser->fullname() . " has posted an important new announcement titled '$title' . To view the announcement, click on this link " .
                            $link->href;
...
//$this->objIndexData->optimize();
                ...
                if ($email) {
                    $link = new link($this->uri(array("action" => "view", "id" => $messageId)));
                    $title = "Important announcement for ".$contextcodeList." titled '$title'";
                    $message = $this->objUser->fullname() . " has posted an important new announcement titled '$title' for '$contextcodeList'. To view the announcement, click on this link " .
                            $link->href;
...
//$this->objIndexData->optimize();
                ...
                if ($email) {
                    $link = new link($this->uri(array("action" => "view", "id" => $messageId)));
                    $title = "Important site announcement: '$title'";
                    $message = $this->objUser->fullname() . " has updated the announcement titled '$title' . To view the announcement, click on this link " .
                            $link->href;
...
// $this->objIndexData->optimize();
                ...
                if ($email) {
                    $link = new link($this->uri(array("action" => "view", "id" => $messageId)));
                    $title = "Important announcement for ".$contextcodeList;
                    $message = $this->objUser->fullname() . " has updated the announcement titled '$title' for '$contextcodeList'. To view the announcement, click on this link " .
                            $link->href;

                    $this->sendEmail($title, $message, $emailList);
                }
            }
        }
    }
