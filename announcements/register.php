...
TEXT: mod_announcements_outofcontext|Out of Context|You must enter a context before viewing this page.
TEXT: mod_announcements_last|Latest|Latest
...
TEXT: mod_announcements_message|Message|Message
TEXT: mod_announcements_createdOn|Created On|Created On
TEXT: mod_announcements_createdBy|Created By|Created By
TEXT: mod_announcements_cellnumber|Cellnumber|Cell Number
TEXT: mod_announcements_address|Address|Address
TEXT: mod_announcements_nonumber|No Number|Contact numbers can only be numeric

TEXT: mod_announcements_delete|Delete record|Delete

TEXT: mod_announcements_empty|Empty|Empty 
TEXT: mod_announcements_edit|Edit a record|Edit 
TEXT: mod_announcements_deleteicon|delete|Are you sure you want to delete this record?
