...
<STYLE>
html{
background-image: url(<?php echo $objSkin->getSkinUrl(); ?>/images/im_bkg.jpg);
...
body {
background-image: url(<?php echo $objSkin->getSkinUrl(); ?>/images/im_side.jpg);
